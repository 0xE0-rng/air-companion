...
public class GenericIdpActivity extends q implements oc {
    ...
    */
    public final android.net.Uri.Builder G(@androidx.annotation.RecentlyNonNull android.net.Uri.Builder r19, @androidx.annotation.RecentlyNonNull android.content.Intent r20, @androidx.annotation.RecentlyNonNull java.lang.String r21, @androidx.annotation.RecentlyNonNull java.lang.String r22) {
        /*
    ...
    public final void onResume() {
        ...
        if (!"android.intent.action.VIEW".equals(getIntent().getAction())) {
            ...
            if (!((g) obj).containsKey(dVarD.f11993c.f12002a)) {
        ...
        if (booleanExtra) {
            stringExtra = h1.g.j(getApplicationContext(), d.d((String) dbVar.f12829q).e()).o(stringExtra);
        }
