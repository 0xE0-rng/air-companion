...
# static fields
.field public static final q:Ljc/n;
...
.method public static constructor <clinit>()V
    ...
    iput-object v1, v0, Ljc/n;->n:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    .line 7
    iput-byte v0, p0, Ljc/n;->o:B

    .line 8
    iput v0, p0, Ljc/n;->p:I

    .line 9
    sget-object v0, Lqc/c;->m:Lqc/c;

    iput-object v0, p0, Ljc/n;->m:Lqc/c;
...
.method public constructor <init>(Lqc/d;Lqc/f;Landroidx/appcompat/widget/m;)V
    ...
    .line 11
    iput-byte p3, p0, Ljc/n;->o:B

    .line 12
    iput p3, p0, Ljc/n;->p:I
    ...
    iput-object p3, p0, Ljc/n;->n:Ljava/util/List;
    ...
    iput-object v4, p0, Ljc/n;->n:Ljava/util/List;

    or-int/lit8 v3, v3, 0x1

    .line 19
    :cond_39
    iget-object v4, p0, Ljc/n;->n:Ljava/util/List;

    sget-object v5, Ljc/n$c;->u:Lqc/r;
    ...
    .line 25
    iget-object p2, p0, Ljc/n;->n:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Ljc/n;->n:Ljava/util/List;
    ...
    iput-object p2, p0, Ljc/n;->m:Lqc/c;
    ...
    .line 29
    iget-object p1, p0, Ljc/n;->n:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Ljc/n;->n:Ljava/util/List;
    ...
    iput-object p1, p0, Ljc/n;->m:Lqc/c;
...
.method public constructor <init>(Lqc/h$b;Landroidx/appcompat/widget/m;)V
    ...
    .line 2
    iput-byte p2, p0, Ljc/n;->o:B

    .line 3
    iput p2, p0, Ljc/n;->p:I
...
.method public a()I
    ...
    .line 2
    :goto_8
    iget-object v2, p0, Ljc/n;->n:Ljava/util/List;
    ...
    .line 4
    :cond_21
    iget-object v0, p0, Ljc/n;->m:Lqc/c;
...
.method public d()Lqc/p$a;
    ...
    .line 2
    invoke-virtual {v0, p0}, Ljc/n$b;->n(Ljc/n;)Ljc/n$b;
...
.method public e(Lqc/e;)V
    ...
    .line 1
    invoke-virtual {p0}, Ljc/n;->a()I

    const/4 v0, 0x0

    .line 2
    :goto_4
    iget-object v1, p0, Ljc/n;->n:Ljava/util/List;
    ...
    .line 4
    :cond_1b
    iget-object p0, p0, Ljc/n;->m:Lqc/c;
...
.method public f()Lqc/p$a;
    ...
    .line 1
    new-instance p0, Ljc/n$b;

    invoke-direct {p0}, Ljc/n$b;-><init>()V
...
.method public final g()Z
    ...
    .line 2
    :goto_b
    iget-object v3, p0, Ljc/n;->n:Ljava/util/List;
    ...
    check-cast v3, Ljc/n$c;

    .line 4
    invoke-virtual {v3}, Ljc/n$c;->g()Z
