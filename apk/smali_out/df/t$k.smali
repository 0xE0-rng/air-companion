...
# direct methods
.method public constructor <init>(Ljava/lang/reflect/Method;ILdf/f;Z)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Ldf/t$k;->a:Ljava/lang/reflect/Method;

    .line 3
    iput p2, p0, Ldf/t$k;->b:I

    .line 4
    iput-boolean p4, p0, Ldf/t$k;->c:Z
...
.method public a(Ldf/v;Ljava/lang/Object;)V
    ...
    .line 6
    iget-boolean v1, p0, Ldf/t$k;->c:Z

    invoke-virtual {p1, v2, v4, v1}, Ldf/v;->d(Ljava/lang/String;Ljava/lang/String;Z)V

    goto :goto_d

    .line 7
    :cond_35
    iget-object p1, p0, Ldf/t$k;->a:Ljava/lang/reflect/Method;

    iget p0, p0, Ldf/t$k;->b:I
    ...
    invoke-static {p2, v2, v3}, La0/c;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
