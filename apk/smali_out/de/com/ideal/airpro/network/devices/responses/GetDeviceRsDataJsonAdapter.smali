.class public final Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsDataJsonAdapter;
.super Lj8/n;
.source "GetDeviceRsDataJsonAdapter.kt"
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "Lj8/n<",
        "Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsData;",
        ">;"
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsDataJsonAdapter;",
        "Lj8/n;",
        "Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsData;",
        "Lj8/z;",
        "moshi",
...
.method public constructor <init>(Lj8/z;)V
    ...
    iput-object v2, p0, Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsDataJsonAdapter;->a:Lj8/s$a;
    ...
    iput-object v0, p0, Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsDataJsonAdapter;->b:Lj8/n;

    .line 4
    const-class v0, Lde/com/ideal/airpro/network/devices/responses/IdealDevice;

    invoke-virtual {p1, v0, v3, v1}, Lj8/z;->d(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lj8/n;

    move-result-object p1

    iput-object p1, p0, Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsDataJsonAdapter;->c:Lj8/n;
...
.method public a(Lj8/s;)Ljava/lang/Object;
    ...
    .line 4
    iget-object v2, p0, Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsDataJsonAdapter;->a:Lj8/s$a;
    ...
    .line 5
    :cond_21
    iget-object v1, p0, Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsDataJsonAdapter;->c:Lj8/n;

    invoke-virtual {v1, p1}, Lj8/n;->a(Lj8/s;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lde/com/ideal/airpro/network/devices/responses/IdealDevice;

    goto :goto_a

    .line 6
    :cond_2a
    iget-object v0, p0, Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsDataJsonAdapter;->b:Lj8/n;
    ...
    .line 10
    new-instance p0, Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsData;
    ...
    .line 12
    invoke-direct {p0, p1, v1}, Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsData;-><init>(ILde/com/ideal/airpro/network/devices/responses/IdealDevice;)V
...
.method public c(Lj8/w;Ljava/lang/Object;)V
    ...
    .line 7
    iget v1, p2, Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsData;->a:I
    ...
    .line 9
    iget-object p0, p0, Lde/com/ideal/airpro/network/devices/responses/GetDeviceRsDataJsonAdapter;->c:Lj8/n;
...
.method public toString()Ljava/lang/String;
    ...
    const-string p0, "GeneratedJsonAdapter(GetDeviceRsData)"
