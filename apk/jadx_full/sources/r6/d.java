...
public abstract class d<K, V> extends r6.f<K, V> implements Serializable {
    ...
    public class e extends d<K, V>.h implements NavigableMap<K, Collection<V>> {
        ...
        /* JADX DEBUG: Method merged with bridge method: c()Ljava/util/SortedSet; */
        ...
        /* JADX DEBUG: Method merged with bridge method: d()Ljava/util/SortedMap; */
        @Override // r6.d.h
    ...
    public class f extends d<K, V>.i implements NavigableSet<K> {
        ...
        /* JADX DEBUG: Method merged with bridge method: b()Ljava/util/SortedMap; */
        @Override // r6.d.i
