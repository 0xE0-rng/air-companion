...
public final class AddDeviceFindingDeviceFragment extends n {
    ...
    */
    public final Object A0(xa.d<? super p> dVar) throws Throwable {
        d dVar2;
        if (dVar instanceof d) {
            dVar2 = (d) dVar;
            int i10 = dVar2.f3967q;
            if ((i10 & Integer.MIN_VALUE) != 0) {
                dVar2.f3967q = i10 - Integer.MIN_VALUE;
            } else {
                dVar2 = new d(dVar);
            }
        }
        Object obj = dVar2.p;
        ya.a aVar = ya.a.COROUTINE_SUSPENDED;
        int i11 = dVar2.f3967q;
        boolean z10 = false;
        if (i11 == 0) {
            d.d.m(obj);
            Group group = (Group) y0(R.id.image_radar);
            if (group != null) {
                group.setVisibility(8);
            }
            ConstraintLayout constraintLayout = (ConstraintLayout) y0(R.id.layout_device_found);
            if (constraintLayout != null) {
                constraintLayout.setVisibility(0);
            }
            TextView textView = (TextView) y0(R.id.text_finding_device_fragment_header);
            if (textView != null) {
                textView.setText(H(R.string.device_found));
            }
            qa.d dVar3 = qa.d.f10312h;
            StringBuilder sbB = android.support.v4.media.a.b("onDeviceFound ->> ");
            WifiManager wifiManager = this.f3961g0;
            if (wifiManager == null) {
                y.m("wifiManager");
                throw null;
            }
            sbB.append(wifiManager.getConnectionInfo());
            sbB.append(" ,");
            sbB.append(z0().f10286n.d());
            dVar3.a("AddDeviceFindingDeviceFragment", sbB.toString());
            this.f3963i0.S(null);
            dVar2.f3969s = this;
            dVar2.f3967q = 1;
            if (t.j(500L, dVar2) == aVar) {
                return aVar;
            }
        } else {
            if (i11 != 1) {
            ...
            this = (AddDeviceFindingDeviceFragment) dVar2.f3969s;
            d.d.m(obj);
        }
        ...
        if (z10) {
            NavHostFragment.y0(this).d(R.id.action_addDeviceFindingDeviceFragment_to_addDeviceSendingInformationFragment);
        }
        return p.f12355a;
    }
