...
public final class RoomActivity extends e.e implements n8.c {
    ...
    */
    public final Object P(xa.d<? super ua.p> dVar) throws Throwable {
        i iVar;
        int i10;
        if (dVar instanceof i) {
            ...
            if ((i11 & Integer.MIN_VALUE) != 0) {
                iVar.f4166q = i11 - Integer.MIN_VALUE;
            } else {
                iVar = new i(dVar);
            }
        }
        ...
        if (i12 == 0) {
            ...
            int i13 = iVar.f4169t;
            RoomActivity roomActivity = (RoomActivity) iVar.f4168s;
            d.d.m(obj);
            i10 = i13;
            this = roomActivity;
        }
        while (true) {
            ...
            if (!j2.y.a(dVar2.f7164e.d(), Boolean.FALSE)) {
                break;
            }
            int i14 = i10 + 1;
            if (i10 >= 20) {
