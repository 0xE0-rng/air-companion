...
public abstract class i implements v0 {
    ...
    /* JADX DEBUG: Method merged with bridge method: p()Ljava/util/Collection; */
    /* JADX DEBUG: Type inference failed for r0v4. Raw type applied. Possible types: java.util.List<? extends gd.e0>, java.util.List<gd.e0> */
    @Override // gd.v0
