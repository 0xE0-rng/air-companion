...
public final class o {
    ...
    public class u extends s7.w<s7.m> {
        /* JADX DEBUG: Method merged with bridge method: a(Lz7/a;)Ljava/lang/Object; */
        @Override // s7.w
        ...
        /* JADX DEBUG: Method merged with bridge method: b(Lz7/c;Ljava/lang/Object;)V */
        /* JADX DEBUG: Multi-variable search result rejected for r0v8, resolved type: V */
        /* JADX DEBUG: Multi-variable search result rejected for r3v2, resolved type: K */
    ...
    public class v extends s7.w<BitSet> {
        ...
        */
        public BitSet a(z7.a aVar) {
            BitSet bitSet = new BitSet();
            aVar.a();
            z7.b bVarJ0 = aVar.j0();
            int i10 = 0;
            while (bVarJ0 != z7.b.END_ARRAY) {
                int i11 = x.f13371a[bVarJ0.ordinal()];
                boolean zL = true;
                if (i11 != 1) {
                    if (i11 == 2) {
                        zL = aVar.L();
                        ...
                        if (i11 != 3) {
                            throw new s7.n("Invalid bitset value type: " + bVarJ0);
                        }
                        String strH0 = aVar.h0();
                        try {
                            if (Integer.parseInt(strH0) == 0) {
                                zL = false;
                            }
                        } catch (NumberFormatException unused) {
                            throw new s7.n(d.a.b("Error: Expecting: bitset number value (1, 0), Found: ", strH0));
                        }
                    }
                } else if (aVar.Z() == 0) {
                }
