...
public final class o4 extends z2 {
    ...
    */
    public final void A(f fVar, int i10, long j10) {
        ...
        if (((m3) this.m).f6427s.t(null, b2.f6228s0)) {
            ...
            z1<Boolean> z1Var = b2.f6230t0;
            int i12 = -10;
            if (eVar.t(null, z1Var) && i10 == -10) {
                i11 = -10;
            } else {
                if (fVar.f6282a == null && fVar.f6283b == null) {
                    ((m3) this.m).e().w.a("Discarding empty consent settings");
                    return;
                }
                i11 = i10;
            }
            synchronized (this.f6478t) {
                z10 = false;
                if (f.i(i11, this.f6479v)) {
                    zF = fVar.f(this.u);
                    if (fVar.e() && !this.u.e()) {
                        z10 = true;
                    }
                    f fVar2 = this.u;
                    Boolean bool = fVar.f6282a;
                    if (bool == null) {
                        bool = fVar2.f6282a;
                    }
                    Boolean bool2 = fVar.f6283b;
                    if (bool2 == null) {
                        bool2 = fVar2.f6283b;
                    }
                    f fVar3 = new f(bool, bool2);
                    this.u = fVar3;
                    this.f6479v = i11;
                    z11 = z10;
                    fVar = fVar3;
            ...
            if (!z10) {
                ((m3) this.m).e().f6452x.b("Ignoring lower-priority consent settings, proposed settings", fVar);
                return;
            }
            long andIncrement = this.w.getAndIncrement();
            if (zF) {
                this.f6477s.set(null);
                l3 l3VarG = ((m3) this.m).g();
                k4 k4Var = new k4(this, fVar, j10, i11, andIncrement, z11);
                l3VarG.m();
                l3VarG.u(new j3<>(l3VarG, k4Var, true, "Task exception on worker thread"));
                return;
            }
            if (((m3) this.m).f6427s.t(null, z1Var)) {
                ...
                l3 l3VarG2 = ((m3) this.m).g();
                l4 l4Var = new l4(this, fVar, i12, andIncrement, z11);
                l3VarG2.m();
                l3VarG2.u(new j3<>(l3VarG2, l4Var, true, "Task exception on worker thread"));
                return;
            }
            ((m3) this.m).g().r(new m4(this, fVar, i11, andIncrement, z11));
        }
    }
    ...
    */
    public final void F(String str, String str2, Bundle bundle, boolean z10, boolean z11, long j10) {
        ...
        if (eVar.t(null, z1Var) && h6.H(str2, "screen_view")) {
            y4 y4VarY = ((m3) this.m).y();
            if (!((m3) y4VarY.m).f6427s.t(null, z1Var)) {
                ((m3) y4VarY.m).e().w.a("Manual screen reporting is disabled.");
                return;
            }
            synchronized (y4VarY.f6638x) {
                if (!y4VarY.w) {
                    ((m3) y4VarY.m).e().w.a("Cannot log screen view event when the app is in the background.");
                    return;
                }
                ...
                if (string != null) {
                    if (string.length() > 0) {
                        ...
                        Objects.requireNonNull((m3) y4VarY.m);
                    }
                    ((m3) y4VarY.m).e().w.b("Invalid screen name length for screen view. Length", Integer.valueOf(string.length()));
                    return;
                }
                ...
                if (string2 != null) {
                    ...
                    ((m3) y4VarY.m).e().w.b("Invalid screen class length for screen view. Length", Integer.valueOf(string2.length()));
                    return;
                }
                if (string2 == null) {
                    Activity activity = y4VarY.f6635s;
                    strR = activity != null ? y4VarY.r(activity.getClass(), "Activity") : "Activity";
                } else {
                    strR = string2;
                }
                u4 u4Var = y4VarY.f6632o;
                if (y4VarY.f6636t && u4Var != null) {
                    y4VarY.f6636t = false;
                    boolean zH = h6.H(u4Var.f6587b, strR);
                    boolean zH2 = h6.H(u4Var.f6586a, string);
                    if (zH && zH2) {
                        ((m3) y4VarY.m).e().w.a("Ignoring call to log screen view event with duplicate parameters.");
                        return;
                    }
                }
                ((m3) y4VarY.m).e().f6454z.c("Logging screen view with name, class", string == null ? "null" : string, strR == null ? "null" : strR);
                u4 u4Var2 = y4VarY.f6632o == null ? y4VarY.p : y4VarY.f6632o;
                u4 u4Var3 = new u4(string, strR, ((m3) y4VarY.m).t().e0(), true, j10);
                y4VarY.f6632o = u4Var3;
                y4VarY.p = u4Var2;
                y4VarY.u = u4Var3;
                Objects.requireNonNull((b7.a) ((m3) y4VarY.m).f6432z);
                ((m3) y4VarY.m).g().r(new u3(y4VarY, bundle2, u4Var3, u4Var2, SystemClock.elapsedRealtime(), 1));
                return;
            }
        }
        G(str3, str2, j10, bundle2, z11, !z11 || this.p == null || h6.G(str2), !z10, null);
    }
    ...
    */
    public final void I(String str, String str2, Object obj, boolean z10, long j10) {
        ...
        if (!z10) {
            h6 h6VarT = ((m3) this.m).t();
            if (h6VarT.i0("user property", str2)) {
                if (h6VarT.k0("user property", bf.e.f2238o, null, str2)) {
                    Objects.requireNonNull((m3) h6VarT.m);
                    if (h6VarT.l0("user property", 24, str2)) {
                        i10 = 0;
                    }
                } else {
                    iN0 = 15;
            ...
            if (i10 == 0) {
                h6 h6VarT2 = ((m3) this.m).t();
                Objects.requireNonNull((m3) this.m);
                ((m3) this.m).t().B(this.B, null, i10, "_ev", h6VarT2.r(str2, 24, true), str2 != null ? str2.length() : 0, ((m3) this.m).f6427s.t(null, b2.x0));
                return;
            } else {
                if (obj == null) {
                ...
                int iY = ((m3) this.m).t().y(str2, obj);
                if (iY != 0) {
                    h6 h6VarT3 = ((m3) this.m).t();
                    Objects.requireNonNull((m3) this.m);
                    ((m3) this.m).t().B(this.B, null, iY, "_ev", h6VarT3.r(str2, 24, true), ((obj instanceof String) || (obj instanceof CharSequence)) ? String.valueOf(obj).length() : 0, ((m3) this.m).f6427s.t(null, b2.x0));
                    return;
                } else {
                    Object objZ = ((m3) this.m).t().z(str2, obj);
                    if (objZ != null) {
                        m(str3, str2, j10, objZ);
                        return;
                    }
                    return;
                }
    ...
    public final void n(String str, String str2, Object obj, long j10) {
        ...
        if (!"allow_personalized_ads".equals(str2)) {
            ...
            if (TextUtils.isEmpty(str4)) {
                ...
                ((m3) this.m).q().f6244y.b(lValueOf.longValue() == 1 ? "true" : "false");
                obj2 = lValueOf;
            }
            str3 = "_npa";
        }
        if (!((m3) this.m).j()) {
            ((m3) this.m).e().f6454z.a("User property not set since app measurement is disabled");
            return;
        }
        if (((m3) this.m).l()) {
            d6 d6Var = new d6(str3, j10, obj2, str);
            i5 i5VarZ = ((m3) this.m).z();
            i5VarZ.i();
            i5VarZ.j();
            i5VarZ.s();
            ...
            Parcel parcelObtain = Parcel.obtain();
            boolean zQ = false;
            e6.a(d6Var, parcelObtain, 0);
            byte[] bArrMarshall = parcelObtain.marshall();
            parcelObtain.recycle();
            if (bArrMarshall.length > 131072) {
                ((m3) h2VarV.m).e().f6449s.a("User property too long for local database. Sending directly to service");
            } else {
                zQ = h2VarV.q(1, bArrMarshall);
            }
            i5VarZ.u(new a5(i5VarZ, i5VarZ.w(true), zQ, d6Var));
        }
    }
