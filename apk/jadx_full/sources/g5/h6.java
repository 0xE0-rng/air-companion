...
public final class h6 extends x3 {
    ...
    */
    public final int s(String str, String str2, String str3, Object obj, Bundle bundle, List<String> list, boolean z10, boolean z11) {
        int i10;
        int i11;
        int size;
        i();
        if (!q0(obj)) {
            ...
            i5VarZ.i();
            i5VarZ.j();
            if (i5VarZ.o() && ((m3) i5VarZ.m).t().N() < 200900) {
                return 25;
            }
            Objects.requireNonNull((m3) this.m);
            ...
            if (size > 200) {
                ((m3) this.m).e().w.d("Parameter array is too long; discarded. Value kind, name, array length", "param", str3, Integer.valueOf(size));
                Objects.requireNonNull((m3) this.m);
                if (z12) {
        ...
        if ((((m3) this.m).f6427s.t(str, b2.R) && G(str2)) || G(str3)) {
            Objects.requireNonNull((m3) this.m);
            i11 = 256;
        } else {
            Objects.requireNonNull((m3) this.m);
        ...
        if (obj instanceof Bundle) {
            s0(str, str2, str3, (Bundle) obj, list, z10);
        } else if (obj instanceof Parcelable[]) {
            for (Parcelable parcelable : (Parcelable[]) obj) {
                if (!(parcelable instanceof Bundle)) {
                    ((m3) this.m).e().w.c("All Parcelable[] elements must be of type Bundle. Value type, name", parcelable.getClass(), str3);
                    return 4;
                }
                s0(str, str2, str3, (Bundle) parcelable, list, z10);
            }
        } else {
            if (!(obj instanceof ArrayList)) {
                return 4;
            ...
            for (int i12 = 0; i12 < size2; i12++) {
                ...
                if (!(obj2 instanceof Bundle)) {
                    ((m3) this.m).e().w.c("All ArrayList elements must be of type Bundle. Value type, name", obj2 != null ? obj2.getClass() : "null", str3);
                    return 4;
                }
                s0(str, str2, str3, (Bundle) obj2, list, z10);
            }
        }
        return i10;
    }
