...
public final class d extends za.h implements p<y, xa.d<? super ua.p>, Object> {
    ...
    public static final class a extends za.h implements p<y, xa.d<? super ua.p>, Object> {
        ...
        */
        public final Object i(Object obj) throws Throwable {
            ...
            d.d.m(obj);
            try {
                T t10 = this.f13910r.m;
                int i10 = ((df.y) t10).f4499a.p;
                if (i10 == 200) {
                    T t11 = ((df.y) t10).f4500b;
                    j2.y.d(t11);
                    List<ChartPoint> list = ((ChartRsData) t11).f3556c.f3538a;
                    int i11 = b.f13898c[d.this.f13906x.ordinal()];
                    if (i11 == 1) {
                        d dVar = d.this;
                        if (dVar.f13907y) {
                            dVar.f13904t.P.j(list);
                        } else {
                            dVar.f13904t.L.j(list);
                        }
                    } else if (i11 == 2) {
                        d dVar2 = d.this;
                        if (dVar2.f13907y) {
                            dVar2.f13904t.Q.j(list);
                        } else {
                            dVar2.f13904t.M.j(list);
                        }
                    } else if (i11 == 3) {
                        d dVar3 = d.this;
                        if (dVar3.f13907y) {
                            dVar3.f13904t.R.j(list);
                        } else {
                            dVar3.f13904t.N.j(list);
                        }
                    } else if (i11 == 4) {
                        d dVar4 = d.this;
                        if (dVar4.f13907y) {
                            dVar4.f13904t.S.j(list);
                        } else {
                            dVar4.f13904t.O.j(list);
                        }
                    }
                } else if (i10 != 401) {
                    d.this.f13904t.U.f7165f.j(new na.d<>(new Integer(R.string.toast_invalid_response_error)));
                } else {
                    d.this.f13904t.U.f7165f.j(new na.d<>(new Integer(R.string.toast_invalid_token_error)));
                }
                aVar = d.this.f13908z;
            } catch (Throwable th) {
                try {
                    qa.d.f10312h.b(d.this.f13904t.m, th.getMessage());
                    d.this.f13904t.U.f7165f.j(new na.d<>(new Integer(R.string.toast_network_error)));
                } finally {
                    db.a aVar3 = d.this.f13908z;
                    if (aVar3 != null) {
                    }
                }
            }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r15v12, resolved type: T */
