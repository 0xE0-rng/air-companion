    ...
    */
    public boolean g(View view, int i10, Bundle bundle) {
        ...
        while (true) {
            ...
            b.a aVar = (b.a) listEmptyList.get(i11);
            if (aVar.a() != i10) {
                i11++;
            } else if (aVar.f7419d != null) {
                d.a aVar2 = null;
                Class<? extends d.a> cls = aVar.f7418c;
                if (cls != null) {
                    try {
                    ...
                    try {
                        Objects.requireNonNull(aVarNewInstance);
                    } catch (Exception e12) {
                        e10 = e12;
                        Class<? extends d.a> cls2 = aVar.f7418c;
                ...
                zPerformAccessibilityAction = aVar.f7419d.a(view, aVar2);
            }
        }
        zPerformAccessibilityAction = false;
        if (!zPerformAccessibilityAction) {
            zPerformAccessibilityAction = this.f6881a.performAccessibilityAction(view, i10, bundle);
        }
        if (zPerformAccessibilityAction || i10 != R.id.accessibility_action_clickable_span) {
        ...
        if (sparseArray != null && (weakReference = (WeakReference) sparseArray.get(i12)) != null) {
            ...
            if (clickableSpan != null) {
                ClickableSpan[] clickableSpanArrD = i0.b.d(view.createAccessibilityNodeInfo().getText());
                for (int i13 = 0; clickableSpanArrD != null && i13 < clickableSpanArrD.length; i13++) {
                    if (clickableSpan.equals(clickableSpanArrD[i13])) {
                        z10 = true;
                        break;
                    }
                }
