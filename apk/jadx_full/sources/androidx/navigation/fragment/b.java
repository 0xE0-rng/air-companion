...
public class b implements y1, j {
    ...
    */
    public static final Object C(e0 e0Var, hc.i iVar, s sVar, q qVar, db.q qVar2) {
        Object objB;
        e0 e0Var2;
        s sVar2;
        Object objC;
        int i10;
        boolean z10;
        y.f(e0Var, "kotlinType");
        y.f(iVar, "factory");
        y.f(sVar, "mode");
        y.f(qVar, "typeMappingConfiguration");
        y.f(qVar2, "writeGenericType");
        e0 e0VarB = qVar.b(e0Var);
        if (e0VarB != null) {
            return C(e0VarB, iVar, sVar, qVar, qVar2);
        }
        if (f.i(e0Var)) {
            boolean zD = qVar.d();
            b0 b0Var = k.f9657a;
            f.i(e0Var);
            ob.g gVarF = v.f(e0Var);
            h hVarS = e0Var.s();
            e0 e0VarE = f.e(e0Var);
            List listG = f.g(e0Var);
            ArrayList arrayList = new ArrayList(va.h.F0(listG, 10));
            Iterator it = listG.iterator();
            while (it.hasNext()) {
                arrayList.add(((y0) it.next()).d());
            }
            h hVar = h.a.f11399a;
            v0 v0VarM = zD ? k.f9658b.m() : k.f9657a.m();
            y.e(v0VarM, "if (isReleaseCoroutines)…ERIMENTAL.typeConstructor");
            List listF1 = l.f1(arrayList, f0.f(hVar, v0VarM, d.c.M(v.b(f.f(e0Var))), false, null, 16));
            l0 l0VarP = v.f(e0Var).p();
            y.e(l0VarP, "suspendFunType.builtIns.nullableAnyType");
            return C(f.b(gVarF, hVarS, e0VarE, listF1, null, l0VarP, false).c1(e0Var.Z0()), iVar, sVar, qVar, qVar2);
        }
        a2.l lVar = a2.l.f32r;
        jd.k kVarY = lVar.y(e0Var);
        Object objD = null;
        if (lVar.J(kVarY)) {
            ob.h hVarI = lVar.I(kVarY);
            if (hVarI != null) {
                xc.b bVar = xc.b.get(hVarI);
                y.e(bVar, "JvmPrimitiveType.get(primitiveType)");
                String desc = bVar.getDesc();
                y.e(desc, "JvmPrimitiveType.get(primitiveType).desc");
                objD = iVar.a(desc);
                if (!lVar.q(e0Var)) {
                    sb.i iVar2 = x.f6769a;
                    oc.b bVar2 = r.f14053j;
                    y.e(bVar2, "JvmAnnotationNames.ENHANCED_NULLABILITY_ANNOTATION");
                    boolean z11 = c.a.o(e0Var, bVar2);
                    if (z11) {
                        objD = iVar.d(objD);
                    }
                }
            } else {
                ob.h hVarH = lVar.H(kVarY);
                if (hVarH != null) {
                    StringBuilder sbB = android.support.v4.media.a.b("[");
                    xc.b bVar3 = xc.b.get(hVarH);
                    y.e(bVar3, "JvmPrimitiveType.get(arrayElementType)");
                    sbB.append(bVar3.getDesc());
                    objD = iVar.a(sbB.toString());
                } else if (lVar.K(kVarY)) {
                    oc.a aVarL = qb.c.m.l(lVar.F(kVarY));
                    if (aVarL != null) {
                        if (!sVar.f7303g) {
                            List<c.a> list = qb.c.f10330l;
                            if ((list instanceof Collection) && list.isEmpty()) {
                                ...
                                while (it2.hasNext()) {
                                    if (y.a(((c.a) it2.next()).f10331a, aVarL)) {
                                        z10 = true;
                                        break;
                                    }
                                }
                                z10 = false;
                                if (!z10) {
                                    String strE = xc.a.b(aVarL).e();
                                    y.e(strE, "JvmClassName.byClassId(classId).internalName");
                                    objD = iVar.b(strE);
                                }
                            }
                        }
        ...
        if (objD != null) {
            ...
            qVar2.f(e0Var, objD, sVar);
            return objD;
        }
        v0 v0VarY0 = e0Var.Y0();
        if (v0VarY0 instanceof c0) {
            c0 c0Var = (c0) v0VarY0;
            e0 e0VarK = c0Var.f6781a;
            if (e0VarK == null) {
                e0VarK = qVar.k(c0Var.f6782b);
            }
            return C(v.k(e0VarK), iVar, sVar, qVar, qVar2);
        }
        ...
        if (gd.x.j(hVarX)) {
            Object objB2 = iVar.b("error/NonExistentClass");
            qVar.g(e0Var, (e) hVarX);
            return objB2;
        }
        boolean z12 = hVarX instanceof e;
        if (z12 && ob.g.A(e0Var)) {
            if (e0Var.X0().size() != 1) {
                throw new UnsupportedOperationException("arrays must have one type argument");
            }
            y0 y0Var = e0Var.X0().get(0);
            e0 e0VarD = y0Var.d();
            y.e(e0VarD, "memberProjection.type");
            if (y0Var.a() == j1.IN_VARIANCE) {
                objC = iVar.b("java/lang/Object");
            } else {
                j1 j1VarA = y0Var.a();
                y.e(j1VarA, "memberProjection.projectionKind");
                if (sVar.f7299c || ((i10 = hc.r.f7295a[j1VarA.ordinal()]) == 1 ? (sVar2 = sVar.f7304h) == null : i10 == 2 ? (sVar2 = sVar.f7305i) == null : (sVar2 = sVar.f7302f) == null)) {
                    sVar2 = sVar;
                }
                objC = C(e0VarD, iVar, sVar2, qVar, qVar2);
            }
            StringBuilder sbB2 = android.support.v4.media.a.b("[");
            sbB2.append(iVar.c(objC));
            return iVar.a(sbB2.toString());
        }
        if (!z12) {
            if (hVarX instanceof p0) {
                return C(v.g((p0) hVarX), iVar, sVar, qVar, b.C0190b.f9382n);
            }
            if ((hVarX instanceof o0) && sVar.f7306j) {
                return C(((o0) hVarX).H0(), iVar, sVar, qVar, qVar2);
            }
            throw new UnsupportedOperationException("Unknown type " + e0Var);
        }
        e eVar = (e) hVarX;
        if (eVar.w() && !sVar.f7298b && (e0Var2 = (e0) d(a2.l.f32r, e0Var, new HashSet())) != null) {
            return C(e0Var2, iVar, new s(sVar.f7297a, true, sVar.f7299c, sVar.f7300d, sVar.f7301e, sVar.f7302f, sVar.f7303g, sVar.f7304h, sVar.f7305i, false, 512), qVar, qVar2);
        }
        if (sVar.f7299c && ob.g.c(eVar, ob.g.f9612k.W)) {
            objB = iVar.e();
        } else {
            e eVarD0 = eVar.d0();
            y.e(eVarD0, "descriptor.original");
            Object objF = qVar.f(eVarD0);
            if (objF != null) {
                objB = objF;
            } else {
                if (eVar.p() == rb.f.ENUM_ENTRY) {
                    rb.k kVarC = eVar.c();
                    Objects.requireNonNull(kVarC, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                    eVar = (e) kVarC;
                }
                e eVarD02 = eVar.d0();
                y.e(eVarD02, "enumClassIfEnumEntry.original");
                objB = iVar.b(e(eVarD02, qVar));
            }
        }
        qVar2.f(e0Var, objB, sVar);
        return objB;
    }

    public static final p D(p pVar, lc.f fVar) {
        y.f(fVar, "typeTable");
        if (pVar.u()) {
            return pVar.f8025y;
        }
    ...
    public static final oc.e E(oc.e eVar, boolean z10) {
        return F(eVar, "set", false, z10 ? "is" : null, 4);
    }

    public static oc.e F(oc.e eVar, String str, boolean z10, String str2, int i10) {
        char cCharAt;
        char cCharAt2;
        Object next;
        if ((i10 & 4) != 0) {
    ...
    public static final p G(jc.h hVar, lc.f fVar) {
        y.f(fVar, "typeTable");
        if (hVar.r()) {
            return hVar.f7943v;
        }
    ...
    public static final void H(xb.c cVar, xb.b bVar, e eVar, oc.e eVar2) {
        xb.a location;
    ...
    public static final void I(xb.c cVar, xb.b bVar, rb.x xVar, oc.e eVar) {
        xb.a location;
        y.f(cVar, "$this$record");
        y.f(xVar, "scopeOwner");
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final String J(oc.e eVar) {
        boolean z10;
        y.f(eVar, "$this$render");
        boolean z11 = false;
        if (!eVar.f9678n) {
            String strF = eVar.f();
            y.e(strF, "asString()");
            if (!((HashSet) rc.p.f11075a).contains(strF)) {
                int i10 = 0;
                while (true) {
                    if (i10 >= strF.length()) {
                        z10 = false;
        ...
        String strF3 = eVar.f();
        y.e(strF3, "asString()");
        sb2.append(String.valueOf('`') + strF3);
        sb2.append('`');
        return sb2.toString();
    }
    ...
    */
    public static final boolean L(e0 e0Var) {
        ...
        if (hVarX == null) {
            ...
            if (m.p(hVarX) && !y.a(wc.b.h((e) hVarX), sc.f.f11423g)) {
                z10 = true;
            }
        }
        return z10 || x(e0Var);
    ...
    public static final void M(d dVar, Object obj, db.l lVar) {
        boolean z10;
        ...
        m0VarA.k0(true);
        try {
            rd.v0 v0Var = (rd.v0) dVar2.c().get(rd.v0.f11136f);
            if (v0Var == null || v0Var.a()) {
                z10 = false;
            } else {
                CancellationException cancellationExceptionK = v0Var.K();
                if (objN instanceof rd.s) {
                    ((rd.s) objN).f11128b.b(cancellationExceptionK);
                }
    ...
    public static final p O(jc.h hVar, lc.f fVar) {
        y.f(fVar, "typeTable");
        if (hVar.t()) {
            p pVar = hVar.f7941s;
            y.e(pVar, "returnType");
    ...
    public static final p P(jc.m mVar, lc.f fVar) {
        y.f(fVar, "typeTable");
        if (mVar.t()) {
            p pVar = mVar.f7982s;
            y.e(pVar, "returnType");
    ...
    public static d1 R(List list, b1 b1Var, rb.k kVar, List list2) {
        if (b1Var == null) {
            a(1);
            throw null;
        }
    ...
    public static d1 S(List list, b1 b1Var, rb.k kVar, List list2, boolean[] zArr) {
        if (list == null) {
            a(5);
            throw null;
        }
    ...
    public static final Class U(rb.k kVar) {
        if (kVar instanceof e) {
            e eVar = (e) kVar;
            if (eVar.w()) {
                Class<?> clsG = mb.y0.g(eVar);
                if (clsG != null) {
                    return clsG;
                }
    ...
    public static final p W(jc.t tVar, lc.f fVar) {
        y.f(fVar, "typeTable");
        if (tVar.r()) {
            p pVar = tVar.f8089r;
            y.e(pVar, "type");
    ...
    public static final Object c(Object obj, rb.b bVar) {
        ...
        Method methodR;
        y.f(bVar, "descriptor");
        return (((bVar instanceof d0) && m.r((t0) bVar)) || (e0VarO = o(bVar)) == null || (clsT = T(e0VarO)) == null || (methodR = r(clsT, bVar)) == null) ? obj : methodR.invoke(obj, new Object[0]);
    }
    ...
    public static final String e(rb.e eVar, q qVar) {
        y.f(eVar, "klass");
        y.f(qVar, "typeMappingConfiguration");
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final nb.e g(nb.e eVar, rb.b bVar, boolean z10) {
        boolean z11;
        e0 e0VarI;
        y.f(eVar, "$this$createInlineClassAwareCallerIfNeeded");
        y.f(bVar, "descriptor");
        boolean z12 = false;
        if (!m.o(bVar)) {
            ...
            if (listK.isEmpty()) {
                z11 = false;
                if (!z11 || ((e0VarI = bVar.i()) != null && m.q(e0VarI))) {
                    z12 = true;
                } else if (!(eVar instanceof nb.d)) {
                    e0 e0VarO = o(bVar);
                    if (e0VarO != null && m.q(e0VarO)) {
                    }
                }
            } else {
                for (s0 s0Var : listK) {
        ...
        return z12 ? new nb.g(bVar, eVar, z10) : eVar;
    }
    ...
    public static final x0 h(rb.e eVar, rb.e eVar2) {
        ...
        return new gd.w0(va.v.I0(l.u1(arrayList, arrayList2)), false);
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: gd.e0 */
    ...
    public static final boolean s(jc.h hVar) {
        y.f(hVar, "$this$hasReceiver");
        return hVar.r() || hVar.s();
    }

    public static final boolean t(jc.m mVar) {
    ...
    public static rd.v0 z(rd.y yVar, xa.f fVar, rd.a0 a0Var, db.p pVar, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            fVar = xa.h.m;
        }
