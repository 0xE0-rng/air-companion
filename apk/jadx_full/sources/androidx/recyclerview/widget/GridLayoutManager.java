...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    */
    public View a0(View view, int i10, RecyclerView.u uVar, RecyclerView.z zVar) {
        ...
        b bVar = (b) viewR.getLayoutParams();
        int i14 = bVar.f1535e;
        int i15 = bVar.f1536f + i14;
        if (super.a0(view, i10, uVar, zVar) == null) {
            return null;
        }
        if ((Q0(i10) == 1) != this.u) {
            iX2 = x() - 1;
        ...
        boolean z11 = this.p == 1 && e1();
        int iU1 = u1(uVar2, zVar2, iX2);
        int i16 = -1;
        int i17 = -1;
        int i18 = i11;
        int iMin = 0;
        ...
        while (i19 != iX) {
            int i20 = iX;
            int iU12 = u1(uVar2, zVar2, i19);
            View viewW = w(i19);
            if (viewW == viewR) {
                break;
            }
            if (!viewW.hasFocusable() || iU12 == iU1) {
                b bVar2 = (b) viewW.getLayoutParams();
                int i21 = bVar2.f1535e;
                view2 = viewR;
                int i22 = bVar2.f1536f + i21;
                if (viewW.hasFocusable() && i21 == i14 && i22 == i15) {
                    return viewW;
                }
                if (!(viewW.hasFocusable() && view4 == null) && (viewW.hasFocusable() || view5 != null)) {
                    view3 = view5;
                    int iMin3 = Math.min(i22, i15) - Math.max(i21, i14);
                    if (!viewW.hasFocusable()) {
                        if (view4 == null) {
                            i12 = iMin;
                            i13 = iU1;
                            if (!(this.f1640c.b(viewW, 24579) && this.f1641d.b(viewW, 24579))) {
                                if (iMin3 <= iMin2) {
                                    if (iMin3 == iMin2) {
                                        if (z11 == (i21 > i16)) {
                                        }
                                        if (z10) {
                                            if (viewW.hasFocusable()) {
                                                int i23 = bVar2.f1535e;
                                                iMin = Math.min(i22, i15) - Math.max(i21, i14);
                                                i17 = i23;
                                                view5 = view3;
                                                view4 = viewW;
                                            } else {
                                                int i24 = bVar2.f1535e;
                                                iMin2 = Math.min(i22, i15) - Math.max(i21, i14);
                                                i16 = i24;
                                                iMin = i12;
                                                view5 = viewW;
                                            }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r13v12, resolved type: android.graphics.Rect */
