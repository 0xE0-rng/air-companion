...
public class StaggeredGridLayoutManager extends RecyclerView.n implements RecyclerView.y.b {
        ...
        public int d(int i10) {
            ...
            if (this.f1723b != null) {
                ...
                while (true) {
                    ...
                    if (this.f1723b.get(i12).m >= i10) {
                        break;
                    }
                    i12++;
                }
                if (i12 != -1) {
                    a aVar = this.f1723b.get(i12);
                    this.f1723b.remove(i12);
                    i11 = aVar.m;
                } else {
                    i11 = -1;
                }
            ...
            int iMin = Math.min(i11 + 1, this.f1722a.length);
            Arrays.fill(this.f1722a, i10, iMin, -1);
            return iMin;
        }
    ...
    public View a0(View view, int i10, RecyclerView.u uVar, RecyclerView.z zVar) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 17) {
                    if (i10 != 33) {
                        if (i10 == 66 ? this.f1709t == 0 : !(i10 != 130 || this.f1709t != 1)) {
                            i11 = 1;
                        }
                    } else if (this.f1709t == 1) {
                        i11 = -1;
                    }
                    i11 = Integer.MIN_VALUE;
                } else if (this.f1709t != 0) {
                    i11 = Integer.MIN_VALUE;
                }
            } else if (this.f1709t != 1 && b1()) {
            }
        } else if (this.f1709t != 1 && b1()) {
        }
        if (i11 == Integer.MIN_VALUE) {
        ...
        c cVar = (c) viewR.getLayoutParams();
        ...
        l1(i11);
        l lVar = this.f1710v;
        lVar.f1851c = lVar.f1852d + iW0;
        lVar.f1850b = (int) (this.f1707r.l() * 0.33333334f);
        l lVar2 = this.f1710v;
        lVar2.f1856h = true;
        lVar2.f1849a = false;
        Q0(uVar, lVar2, zVar);
        this.D = this.f1711x;
        View viewI = fVar.i(iW0, i11);
        if (viewI != null && viewI != viewR) {
            return viewI;
        }
        if (e1(i11)) {
            for (int i12 = this.p - 1; i12 >= 0; i12--) {
                View viewI2 = this.f1706q[i12].i(iW0, i11);
                if (viewI2 != null && viewI2 != viewR) {
                    return viewI2;
                }
            }
        } else {
            for (int i13 = 0; i13 < this.p; i13++) {
                View viewI3 = this.f1706q[i13].i(iW0, i11);
                if (viewI3 != null && viewI3 != viewR) {
                    return viewI3;
                }
            }
        }
        boolean z10 = (this.w ^ true) == (i11 == -1);
        View viewS = s(z10 ? fVar.e() : fVar.f());
        ...
        if (e1(i11)) {
            for (int i14 = this.p - 1; i14 >= 0; i14--) {
                if (i14 != fVar.f1737e) {
                    View viewS2 = s(z10 ? this.f1706q[i14].e() : this.f1706q[i14].f());
            ...
            for (int i15 = 0; i15 < this.p; i15++) {
                View viewS3 = s(z10 ? this.f1706q[i15].e() : this.f1706q[i15].f());
    ...
    */
    public View a1() {
        ...
        byte b10 = (this.f1709t == 1 && b1()) ? (byte) 1 : (byte) -1;
        if (this.f1711x) {
            i10 = -1;
        } else {
            i10 = iX + 1;
        ...
        while (iX != i10) {
            ...
            if (bitSet.get(cVar.f1721e.f1737e)) {
                f fVar = cVar.f1721e;
                if (this.f1711x) {
                    int i12 = fVar.f1735c;
                    if (i12 == Integer.MIN_VALUE) {
                    ...
                    if (i12 < this.f1707r.g()) {
                        ArrayList<View> arrayList = fVar.f1733a;
                    ...
                    if (i13 > this.f1707r.k()) {
                        Objects.requireNonNull(fVar.j(fVar.f1733a.get(0)));
                        z11 = true;
                    }
                    z11 = false;
                }
                ...
                bitSet.clear(cVar.f1721e.f1737e);
            }
            int i14 = iX + i11;
            if (i14 != i10) {
                View viewW2 = w(i14);
                ...
                if (z10) {
                    if ((cVar.f1721e.f1737e - ((c) viewW2.getLayoutParams()).f1721e.f1737e < 0) != (b10 < 0)) {
                        return viewW;
                    }
                } else {
                    continue;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void d1(RecyclerView.u uVar, RecyclerView.z zVar, boolean z10) {
        e eVar;
        boolean z11;
        int iP;
        int i10;
        b bVar = this.H;
        if (!(this.F == null && this.f1713z == -1) && zVar.b() == 0) {
            q0(uVar);
            bVar.b();
            return;
        }
        boolean z12 = true;
        boolean z13 = (bVar.f1718e && this.f1713z == -1 && this.F == null) ? false : true;
        if (z13) {
            bVar.b();
            e eVar2 = this.F;
            if (eVar2 != null) {
                int i11 = eVar2.f1727o;
                if (i11 > 0) {
                    if (i11 == this.p) {
                        for (int i12 = 0; i12 < this.p; i12++) {
                            ...
                            if (iG != Integer.MIN_VALUE) {
                                iG += eVar3.u ? this.f1707r.g() : this.f1707r.k();
                            }
                            f fVar = this.f1706q[i12];
                            fVar.f1734b = iG;
                            fVar.f1735c = iG;
                        }
                    } else {
                        ...
                        eVar2.f1729r = null;
                        eVar2.f1730s = null;
                        eVar2.m = eVar2.f1726n;
                    }
                }
                e eVar4 = this.F;
                this.E = eVar4.f1732v;
                boolean z14 = eVar4.f1731t;
                d(null);
                e eVar5 = this.F;
                if (eVar5 != null && eVar5.f1731t != z14) {
                    eVar5.f1731t = z14;
                }
                this.w = z14;
                w0();
                ...
                if (i13 != -1) {
                    ...
                    bVar.f1716c = this.f1711x;
                }
                if (eVar6.f1728q > 1) {
                    d dVar = this.B;
                    dVar.f1722a = eVar6.f1729r;
                    dVar.f1723b = eVar6.f1730s;
                }
            } else {
                j1();
                bVar.f1716c = this.f1711x;
            }
            if (zVar.f1699g || (i10 = this.f1713z) == -1) {
                z11 = false;
                if (!z11) {
                    if (this.D) {
                        int iB = zVar.b();
                ...
                e eVar7 = this.F;
                if (eVar7 == null || eVar7.m == -1 || eVar7.f1727o < 1) {
                    View viewS = s(this.f1713z);
                    if (viewS != null) {
                        bVar.f1714a = this.f1711x ? W0() : V0();
                        if (this.A != Integer.MIN_VALUE) {
                            if (bVar.f1716c) {
                                bVar.f1715b = (this.f1707r.g() - this.A) - this.f1707r.b(viewS);
                            } else {
                                bVar.f1715b = (this.f1707r.k() + this.A) - this.f1707r.e(viewS);
                            }
                        } else if (this.f1707r.c(viewS) > this.f1707r.l()) {
                            bVar.f1715b = bVar.f1716c ? this.f1707r.g() : this.f1707r.k();
                        } else {
                            int iE = this.f1707r.e(viewS) - this.f1707r.k();
                            if (iE < 0) {
                                bVar.f1715b = -iE;
                            } else {
                                int iG2 = this.f1707r.g() - this.f1707r.b(viewS);
                                if (iG2 < 0) {
                                    bVar.f1715b = iG2;
                                } else {
                                    bVar.f1715b = Integer.MIN_VALUE;
                        ...
                        if (i16 == Integer.MIN_VALUE) {
                            bVar.f1716c = L0(i15) == 1;
                            bVar.a();
                        } else if (bVar.f1716c) {
                            bVar.f1715b = StaggeredGridLayoutManager.this.f1707r.g() - i16;
                        } else {
                            bVar.f1715b = StaggeredGridLayoutManager.this.f1707r.k() + i16;
                        }
                        bVar.f1717d = true;
                    }
                } else {
                    bVar.f1715b = Integer.MIN_VALUE;
                    bVar.f1714a = this.f1713z;
                }
                z11 = true;
                if (!z11) {
                }
        ...
        if (this.F == null && this.f1713z == -1 && (bVar.f1716c != this.D || b1() != this.E)) {
            this.B.a();
            bVar.f1717d = true;
        }
        if (x() > 0 && ((eVar = this.F) == null || eVar.f1727o < 1)) {
            if (bVar.f1717d) {
                for (int i17 = 0; i17 < this.p; i17++) {
                    this.f1706q[i17].d();
                    int i18 = bVar.f1715b;
                    if (i18 != Integer.MIN_VALUE) {
                        f fVar2 = this.f1706q[i17];
                        fVar2.f1734b = i18;
                        fVar2.f1735c = i18;
                    }
                }
            } else if (z13 || this.H.f1719f == null) {
                for (int i19 = 0; i19 < this.p; i19++) {
                    f fVar3 = this.f1706q[i19];
                    boolean z15 = this.f1711x;
                    int i20 = bVar.f1715b;
                    int iH = z15 ? fVar3.h(Integer.MIN_VALUE) : fVar3.k(Integer.MIN_VALUE);
                    fVar3.d();
                    if (iH != Integer.MIN_VALUE && ((!z15 || iH >= StaggeredGridLayoutManager.this.f1707r.g()) && (z15 || iH <= StaggeredGridLayoutManager.this.f1707r.k()))) {
                ...
                b bVar2 = this.H;
                f[] fVarArr = this.f1706q;
                Objects.requireNonNull(bVar2);
                int length = fVarArr.length;
                int[] iArr = bVar2.f1719f;
                if (iArr == null || iArr.length < length) {
                    bVar2.f1719f = new int[StaggeredGridLayoutManager.this.f1706q.length];
                }
                for (int i21 = 0; i21 < length; i21++) {
                    bVar2.f1719f[i21] = fVarArr[i21].k(Integer.MIN_VALUE);
                }
            } else {
                for (int i22 = 0; i22 < this.p; i22++) {
                    f fVar4 = this.f1706q[i22];
                    fVar4.d();
                    int i23 = this.H.f1719f[i22];
                    fVar4.f1734b = i23;
                    fVar4.f1735c = i23;
                }
            }
        ...
        q(uVar);
        this.f1710v.f1849a = false;
        int iL = this.f1708s.l();
        this.u = iL / this.p;
        View.MeasureSpec.makeMeasureSpec(iL, this.f1708s.i());
        n1(bVar.f1714a, zVar);
        if (bVar.f1716c) {
            l1(-1);
            Q0(uVar, this.f1710v, zVar);
            l1(1);
            l lVar = this.f1710v;
            lVar.f1851c = bVar.f1714a + lVar.f1852d;
            Q0(uVar, lVar, zVar);
        } else {
            l1(1);
            Q0(uVar, this.f1710v, zVar);
            l1(-1);
            l lVar2 = this.f1710v;
            lVar2.f1851c = bVar.f1714a + lVar2.f1852d;
            Q0(uVar, lVar2, zVar);
        }
        if (this.f1708s.i() != 1073741824) {
            float fMax = 0.0f;
            int iX3 = x();
            for (int i24 = 0; i24 < iX3; i24++) {
                View viewW = w(i24);
                float fC = this.f1708s.c(viewW);
                if (fC >= fMax) {
                    Objects.requireNonNull((c) viewW.getLayoutParams());
                    fMax = Math.max(fMax, fC);
                }
            }
            int i25 = this.u;
            int iRound = Math.round(fMax * this.p);
            if (this.f1708s.i() == Integer.MIN_VALUE) {
                iRound = Math.min(iRound, this.f1708s.l());
            }
            this.u = iRound / this.p;
            View.MeasureSpec.makeMeasureSpec(iRound, this.f1708s.i());
            if (this.u != i25) {
                for (int i26 = 0; i26 < iX3; i26++) {
                    View viewW2 = w(i26);
                    c cVar = (c) viewW2.getLayoutParams();
                    Objects.requireNonNull(cVar);
                    if (b1() && this.f1709t == 1) {
                        int i27 = this.p;
                        int i28 = cVar.f1721e.f1737e;
                        viewW2.offsetLeftAndRight(((-((i27 - 1) - i28)) * this.u) - ((-((i27 - 1) - i28)) * i25));
                    } else {
                        int i29 = cVar.f1721e.f1737e;
                        int i30 = this.u * i29;
                        int i31 = i29 * i25;
                        if (this.f1709t == 1) {
                            viewW2.offsetLeftAndRight(i30 - i31);
                        } else {
                            viewW2.offsetTopAndBottom(i30 - i31);
                        }
                    }
                }
            }
        ...
        if (!z10 || zVar.f1699g) {
            z12 = false;
        } else if ((this.C == 0 || x() <= 0 || a1() == null) ? false : true) {
            Runnable runnable = this.K;
            RecyclerView recyclerView = this.f1639b;
            if (recyclerView != null) {
