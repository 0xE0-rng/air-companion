...
public class RecyclerView extends ViewGroup implements h0.g {
    ...
    public static abstract class k {
        ...
        /* JADX DEBUG: Incorrect args count in method signature: (Landroidx/recyclerview/widget/RecyclerView$z;Landroidx/recyclerview/widget/RecyclerView$c0;ILjava/util/List<Ljava/lang/Object;>;)Landroidx/recyclerview/widget/RecyclerView$k$c; */
        public c l(c0 c0Var) {
            c cVar = new c();
            View view = c0Var.f1607a;
    ...
    public static abstract class n {
        ...
        */
        public boolean v0(RecyclerView recyclerView, View view, Rect rect, boolean z10, boolean z11) {
            ...
            int iM = M();
            int iO = O();
            int iN = this.f1650n - N();
            int iL = this.f1651o - L();
            ...
            int iMax2 = Math.max(0, iHeight - iL);
            if (I() != 1) {
                if (iMin == 0) {
            ...
            if (z11) {
                ...
                if (focusedChild == null) {
                    ...
                    int iM2 = M();
                    int iO2 = O();
                    int iN2 = this.f1650n - N();
                    int iL2 = this.f1651o - L();
                    Rect rect2 = this.f1639b.u;
                    RecyclerView.L(focusedChild, rect2);
                    if (rect2.left - i13 < iN2 && rect2.right - i13 > iM2 && rect2.top - i14 < iL2 && rect2.bottom - i14 > iO2) {
                        z12 = true;
                    }
                    if (z12) {
                    }
                ...
                if (z10) {
                    ...
                    recyclerView.h0(i13, i14, null, Integer.MIN_VALUE, false);
                }
                return true;
            }
            return false;
    ...
    public final class u {
        ...
        */
        public void h(c0 c0Var) {
            ...
            boolean z11;
            boolean z12;
            if (c0Var.n() || c0Var.f1607a.getParent() != null) {
                StringBuilder sbB = android.support.v4.media.a.b("Scrapped or attached views may not be recycled. isScrap:");
                sbB.append(c0Var.n());
                sbB.append(" isAttached:");
                sbB.append(c0Var.f1607a.getParent() != null);
                throw new IllegalArgumentException(r8.g.b(RecyclerView.this, sbB));
            }
            if (c0Var.o()) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append("Tmp detached view should be removed from RecyclerView before it can be recycled: ");
                sb2.append(c0Var);
                throw new IllegalArgumentException(r8.g.b(RecyclerView.this, sb2));
            }
            if (c0Var.u()) {
                throw new IllegalArgumentException(r8.g.b(RecyclerView.this, android.support.v4.media.a.b("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
            if ((c0Var.f1616j & 16) == 0) {
                View view = c0Var.f1607a;
                WeakHashMap<View, h0.s> weakHashMap = h0.p.f6907a;
            ...
            if (c0Var.l()) {
                if (this.f1673f <= 0 || c0Var.h(526)) {
                    z12 = false;
                } else {
                    int size = this.f1670c.size();
                    if (size >= this.f1673f && size > 0) {
                        f(0);
                        size--;
                    }
                    int[] iArr = RecyclerView.N0;
                    if (size > 0 && !RecyclerView.this.f1592s0.c(c0Var.f1609c)) {
                        do {
                            size--;
                            if (size < 0) {
                                break;
                            }
                        } while (RecyclerView.this.f1592s0.c(this.f1670c.get(size).f1609c));
                        size++;
                    }
                    this.f1670c.add(size, c0Var);
                    z12 = true;
                }
                if (!z12) {
                    a(c0Var, true);
            ...
            RecyclerView.this.f1589r.g(c0Var);
            if (z || z11 || !z10) {
                return;
            }
            c0Var.f1623s = null;
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public c0 j(int i10, boolean z10, long j10) {
            c0 c0VarK;
            boolean z11;
            boolean z12;
            boolean z13;
            ...
            if (i10 < 0 || i10 >= RecyclerView.this.f1594t0.b()) {
                ...
                sb2.append(RecyclerView.this.f1594t0.b());
                throw new IndexOutOfBoundsException(r8.g.b(RecyclerView.this, sb2));
            }
            boolean z15 = false;
            if (RecyclerView.this.f1594t0.f1699g) {
                ArrayList<c0> arrayList = this.f1669b;
                if (arrayList == null || (size = arrayList.size()) == 0) {
                    ...
                    while (true) {
                        if (i11 >= size) {
                            RecyclerView recyclerView = RecyclerView.this;
                            if (recyclerView.f1597x.f1627b && (iF = recyclerView.p.f(i10, 0)) > 0 && iF < RecyclerView.this.f1597x.a()) {
                                long jB = RecyclerView.this.f1597x.b(iF);
                                for (int i12 = 0; i12 < size; i12++) {
                                    c0 c0Var2 = this.f1669b.get(i12);
                                    if (!c0Var2.v() && c0Var2.f1611e == jB) {
                                        c0Var2.b(32);
                                        c0VarK = c0Var2;
                                        break;
                                    }
                            ...
                            c0VarK = this.f1669b.get(i11);
                            if (!c0VarK.v() && c0VarK.f() == i10) {
                                c0VarK.b(32);
                                break;
                            }
                            i11++;
                ...
                if (c0VarK == null) {
                    ...
                    for (int i13 = 0; i13 < size2; i13++) {
                        c0Var = this.f1668a.get(i13);
                        if (!c0Var.v() && c0Var.f() == i10 && !c0Var.k() && (RecyclerView.this.f1594t0.f1699g || !c0Var.m())) {
                            c0Var.b(32);
                            break;
                        }
                    }
                    if (!z10) {
                        androidx.recyclerview.widget.b bVar = RecyclerView.this.f1587q;
                        int size3 = bVar.f1757c.size();
                        int i14 = 0;
                        while (true) {
                            if (i14 >= size3) {
                                view = null;
                            ...
                            view = bVar.f1757c.get(i14);
                            Objects.requireNonNull((androidx.recyclerview.widget.t) bVar.f1755a);
                            c0 c0VarK2 = RecyclerView.K(view);
                            if (c0VarK2.f() == i10 && !c0VarK2.k() && !c0VarK2.m()) {
                                break;
                            }
                            i14++;
                        }
                        if (view != null) {
                            c0VarK = RecyclerView.K(view);
                            androidx.recyclerview.widget.b bVar2 = RecyclerView.this.f1587q;
                            int iIndexOfChild = ((androidx.recyclerview.widget.t) bVar2.f1755a).f1871a.indexOfChild(view);
                            if (iIndexOfChild < 0) {
                                throw new IllegalArgumentException("view is not a child, cannot hide " + view);
                            }
                            if (!bVar2.f1756b.d(iIndexOfChild)) {
                                throw new RuntimeException("trying to unhide a view that was not hidden" + view);
                            }
                            bVar2.f1756b.a(iIndexOfChild);
                            bVar2.l(view);
                            int iJ = RecyclerView.this.f1587q.j(view);
                            if (iJ == -1) {
                                StringBuilder sb3 = new StringBuilder();
                                sb3.append("layout index should not be -1 after unhiding a view:");
                                sb3.append(c0VarK);
                                throw new IllegalStateException(r8.g.b(RecyclerView.this, sb3));
                            }
                            RecyclerView.this.f1587q.c(iJ);
                            i(view);
                            c0VarK.b(8224);
                        } else {
                            int size4 = this.f1670c.size();
                            for (int i15 = 0; i15 < size4; i15++) {
                                c0Var = this.f1670c.get(i15);
                                if (!c0Var.k() && c0Var.f() == i10 && !c0Var.i()) {
                                    if (!z10) {
                                        this.f1670c.remove(i15);
                                    }
                                    c0VarK = c0Var;
                                }
                            }
                        ...
                        if (c0VarK != null) {
                            if (c0VarK.m()) {
                                z14 = RecyclerView.this.f1594t0.f1699g;
                            } else {
                                int i16 = c0VarK.f1609c;
                                if (i16 < 0 || i16 >= RecyclerView.this.f1597x.a()) {
                                    StringBuilder sb4 = new StringBuilder();
                                    sb4.append("Inconsistency detected. Invalid view holder adapter position");
                                    sb4.append(c0VarK);
                                    throw new IndexOutOfBoundsException(r8.g.b(RecyclerView.this, sb4));
                                }
                                RecyclerView recyclerView2 = RecyclerView.this;
                                if (!recyclerView2.f1594t0.f1699g) {
                                    Objects.requireNonNull(recyclerView2.f1597x);
                                    if (c0VarK.f1612f != 0) {
                                        z14 = false;
                                    } else {
                                        f fVar = RecyclerView.this.f1597x;
                                        if (!fVar.f1627b || c0VarK.f1611e == fVar.b(c0VarK.f1609c)) {
                                            z14 = true;
                                        }
                                    }
                                }
                            ...
                            if (z14) {
                                ...
                                if (!z10) {
                                    c0VarK.b(4);
                                    if (c0VarK.n()) {
                                        RecyclerView.this.removeDetachedView(c0VarK.f1607a, false);
                                        c0VarK.f1619n.k(c0VarK);
                                    } else if (c0VarK.v()) {
                                        c0VarK.d();
                                    }
                ...
                if (c0VarK == null) {
                    int iF2 = RecyclerView.this.p.f(i10, 0);
                    if (iF2 < 0 || iF2 >= RecyclerView.this.f1597x.a()) {
                        ...
                        sb5.append(iF2);
                        sb5.append(").state:");
                        sb5.append(RecyclerView.this.f1594t0.b());
                        throw new IndexOutOfBoundsException(r8.g.b(RecyclerView.this, sb5));
                    }
                    Objects.requireNonNull(RecyclerView.this.f1597x);
                    f fVar2 = RecyclerView.this.f1597x;
                    if (fVar2.f1627b) {
                        long jB2 = fVar2.b(iF2);
                        int size5 = this.f1668a.size() - 1;
                        while (true) {
                            if (size5 >= 0) {
                                c0 c0Var3 = this.f1668a.get(size5);
                                if (c0Var3.f1611e == jB2 && !c0Var3.v()) {
                                    if (c0Var3.f1612f == 0) {
                                        c0Var3.b(32);
                                        if (c0Var3.m() && !RecyclerView.this.f1594t0.f1699g) {
                                            c0Var3.s(2, 14);
                                        }
                                        c0VarK = c0Var3;
                                    } else if (!z10) {
                                        this.f1668a.remove(size5);
                                        RecyclerView.this.removeDetachedView(c0Var3.f1607a, false);
                                        c0 c0VarK3 = RecyclerView.K(c0Var3.f1607a);
                                        c0VarK3.f1619n = null;
                                        c0VarK3.f1620o = false;
                                        c0VarK3.d();
                                        h(c0VarK3);
                                    }
                                }
                                ...
                                int size6 = this.f1670c.size() - 1;
                                while (true) {
                                    if (size6 < 0) {
                                        break;
                                    }
                                    c0VarK = this.f1670c.get(size6);
                                    if (c0VarK.f1611e == jB2 && !c0VarK.i()) {
                                        if (c0VarK.f1612f != 0) {
                                            if (!z10) {
                                                f(size6);
                                                break;
                    ...
                    if (c0VarK == null) {
                        ...
                        if (aVar == null || aVar.f1664a.isEmpty()) {
                            ...
                            ArrayList<c0> arrayList2 = aVar.f1664a;
                            for (int size7 = arrayList2.size() - 1; size7 >= 0; size7--) {
                                if (!arrayList2.get(size7).i()) {
                                    c0VarRemove = arrayList2.remove(size7);
                                    break;
                                }
                            }
                            c0VarRemove = null;
                    ...
                    if (c0VarK == null) {
                        ...
                        if (j10 != Long.MAX_VALUE) {
                            long j11 = this.f1674g.a(0).f1666c;
                            if (!(j11 == 0 || j11 + nanoTime < j10)) {
                                return null;
                            }
                        }
                        RecyclerView recyclerView3 = RecyclerView.this;
                        f fVar3 = recyclerView3.f1597x;
                        Objects.requireNonNull(fVar3);
                        try {
                            Trace.beginSection("RV CreateView");
                            c0 c0VarE = fVar3.e(recyclerView3, 0);
                            if (c0VarE.f1607a.getParent() != null) {
                                throw new IllegalStateException("ViewHolder views must not be attached when created. Ensure that you are not passing 'true' to the attachToRoot parameter of LayoutInflater.inflate(..., boolean attachToRoot)");
                            }
                            c0VarE.f1612f = 0;
                            Trace.endSection();
                            int[] iArr2 = RecyclerView.N0;
                            RecyclerView recyclerViewF = RecyclerView.F(c0VarE.f1607a);
                            if (recyclerViewF != null) {
                                c0VarE.f1608b = new WeakReference<>(recyclerViewF);
                            }
                            long nanoTime2 = RecyclerView.this.getNanoTime();
                            t tVar = this.f1674g;
                            long j12 = nanoTime2 - nanoTime;
                            t.a aVarA = tVar.a(0);
                            aVarA.f1666c = tVar.b(aVarA.f1666c, j12);
                            c0VarK = c0VarE;
                        } finally {
                            Trace.endSection();
                        }
                ...
                if (z11 && !RecyclerView.this.f1594t0.f1699g && c0VarK.h(8192)) {
                    c0VarK.s(0, 8192);
                    if (RecyclerView.this.f1594t0.f1702j) {
                        k.e(c0VarK);
                        k kVar = RecyclerView.this.f1571b0;
                        c0VarK.g();
                        RecyclerView.this.Z(c0VarK, kVar.l(c0VarK));
                    }
                }
                if (RecyclerView.this.f1594t0.f1699g || !c0VarK.j()) {
                    if (!c0VarK.j()) {
                        int iF3 = RecyclerView.this.p.f(i10, 0);
                        c0VarK.f1623s = null;
                        RecyclerView recyclerView4 = RecyclerView.this;
                        c0VarK.f1622r = recyclerView4;
                        int i17 = c0VarK.f1612f;
                        long nanoTime3 = recyclerView4.getNanoTime();
                        if (j10 != Long.MAX_VALUE) {
                            long j13 = this.f1674g.a(i17).f1667d;
                            if (!(j13 == 0 || j13 + nanoTime3 < j10)) {
                            }
                        }
                        f<? extends c0> fVar4 = RecyclerView.this.f1597x;
                        Objects.requireNonNull(fVar4);
                        boolean z16 = c0VarK.f1623s == null;
                        if (z16) {
                            c0VarK.f1609c = iF3;
                            if (fVar4.f1627b) {
                                c0VarK.f1611e = fVar4.b(iF3);
                            }
                            c0VarK.s(1, 519);
                        ...
                        fVar4.d(c0VarK, iF3);
                        if (z16) {
                            List<Object> list = c0VarK.f1617k;
                            if (list != null) {
                                list.clear();
                            }
                            c0VarK.f1616j &= -1025;
                            ViewGroup.LayoutParams layoutParams2 = c0VarK.f1607a.getLayoutParams();
                            if (layoutParams2 instanceof o) {
                                ((o) layoutParams2).f1660c = true;
                            }
                        }
                        long nanoTime4 = RecyclerView.this.getNanoTime();
                        t tVar2 = this.f1674g;
                        long j14 = nanoTime4 - nanoTime3;
                        t.a aVarA2 = tVar2.a(c0VarK.f1612f);
                        aVarA2.f1667d = tVar2.b(aVarA2.f1667d, j14);
                        AccessibilityManager accessibilityManager = RecyclerView.this.N;
                        if (accessibilityManager != null && accessibilityManager.isEnabled()) {
                            ...
                            androidx.recyclerview.widget.v vVar = RecyclerView.this.A0;
                            if (vVar != null) {
                                v.a aVar2 = vVar.f1874e;
                                if (aVar2 instanceof v.a) {
                                    Objects.requireNonNull(aVar2);
                                    h0.a aVarD = h0.p.d(view2);
                                    if (aVarD != null && aVarD != aVar2) {
                                        aVar2.f1876e.put(view2, aVarD);
                                    }
                                }
                                h0.p.m(view2, aVar2);
                            }
                        ...
                        z13 = z12;
                    } else if (((c0VarK.f1616j & 2) != 0) || c0VarK.k()) {
                    }
                    layoutParams = c0VarK.f1607a.getLayoutParams();
                    if (layoutParams == null) {
                        oVar = (o) RecyclerView.this.generateDefaultLayoutParams();
                        c0VarK.f1607a.setLayoutParams(oVar);
    ...
    public static abstract class y {
        ...
        */
        public void b(int i10, int i11) {
            PointF pointFA;
            RecyclerView recyclerView = this.f1679b;
            if (this.f1678a == -1 || recyclerView == null) {
                d();
            }
            if (this.f1681d && this.f1683f == null && this.f1680c != null && (pointFA = a(this.f1678a)) != null) {
                float f6 = pointFA.x;
                if (f6 != 0.0f || pointFA.y != 0.0f) {
                    recyclerView.e0((int) Math.signum(f6), (int) Math.signum(pointFA.y), null);
                }
            }
            this.f1681d = false;
            ...
            if (view != null) {
                ...
                c0 c0VarK = RecyclerView.K(view);
                if ((c0VarK != null ? c0VarK.f() : -1) == this.f1678a) {
                    c(this.f1683f, recyclerView.f1594t0, this.f1684g);
                    this.f1684g.a(recyclerView);
                    d();
                } else {
            ...
            if (this.f1682e) {
                ...
                if (mVar.f1679b.f1598y.x() == 0) {
                    ...
                    mVar.p = i15;
                    if (i13 == 0 && i15 == 0) {
                        PointF pointFA2 = mVar.a(mVar.f1678a);
                        if (pointFA2 != null) {
                            if (pointFA2.x == 0.0f && pointFA2.y == 0.0f) {
                                aVar.f1689d = mVar.f1678a;
                                mVar.d();
                            } else {
                                float f10 = pointFA2.y;
                                float fSqrt = (float) Math.sqrt((f10 * f10) + (r9 * r9));
                                float f11 = pointFA2.x / fSqrt;
                                pointFA2.x = f11;
                                float f12 = pointFA2.y / fSqrt;
                                pointFA2.y = f12;
                                mVar.f1860k = pointFA2;
                                mVar.f1863o = (int) (f11 * 10000.0f);
                                mVar.p = (int) (f12 * 10000.0f);
                                aVar.b((int) (mVar.f1863o * 1.2f), (int) (mVar.p * 1.2f), (int) (mVar.g(10000) * 1.2f), mVar.f1858i);
                            }
                        }
                    }
                }
                a aVar2 = this.f1684g;
                boolean z10 = aVar2.f1689d >= 0;
                aVar2.a(recyclerView);
                if (z10 && this.f1682e) {
                    this.f1681d = true;
                    recyclerView.f1588q0.a();
                }
            }
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public boolean d0(int i10, int i11, MotionEvent motionEvent, int i12) {
        int i13;
        int i14;
        int i15;
        int i16;
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        u(i14, i13, i15, i16, this.E0, i12, iArr3);
        int[] iArr4 = this.G0;
        int i19 = i15 - iArr4[0];
        int i20 = i16 - iArr4[1];
        boolean z11 = (iArr4[0] == 0 && iArr4[1] == 0) ? false : true;
        int i21 = this.f1577h0;
        int[] iArr5 = this.E0;
        this.f1577h0 = i21 - iArr5[0];
        this.f1578i0 -= iArr5[1];
        int[] iArr6 = this.F0;
        ...
        if (getOverScrollMode() != 2) {
            if (motionEvent != null) {
                if (!((motionEvent.getSource() & 8194) == 8194)) {
                    ...
                    if (f6 < 0.0f) {
                        x();
                        this.U.onPull((-f6) / getWidth(), 1.0f - (y10 / getHeight()));
                    } else if (f6 > 0.0f) {
                        y();
                        this.W.onPull(f6 / getWidth(), y10 / getHeight());
                    } else {
                        z10 = false;
                        if (f10 >= 0.0f) {
                            z();
                            this.V.onPull((-f10) / getHeight(), x10 / getWidth());
                        } else {
                            if (f10 > 0.0f) {
                                w();
                                this.f1570a0.onPull(f10 / getHeight(), 1.0f - (x10 / getWidth()));
                            }
                            if (z10 || f6 != 0.0f || f10 != 0.0f) {
                                WeakHashMap<View, h0.s> weakHashMap = h0.p.f6907a;
                                postInvalidateOnAnimation();
                            }
                        }
    ...
    */
    public View focusSearch(View view, int i10) {
        ...
        byte b10;
        boolean z10;
        Objects.requireNonNull(this.f1598y);
        boolean z11 = true;
        boolean z12 = (this.f1597x == null || this.f1598y == null || P() || this.J) ? false : true;
        ...
        if (!z12 || (i10 != 2 && i10 != 1)) {
            ...
            if (viewFindNextFocus == null && z12) {
                ...
                j0();
                viewA0 = this.f1598y.a0(view, i10, this.f1583n, this.f1594t0);
                l0(false);
            } else {
                viewA0 = viewFindNextFocus;
            }
        } else if (this.f1598y.f()) {
            if (focusFinder.findNextFocus(this, view, i10 == 2 ? 130 : 33) == null) {
                z10 = true;
            }
            if (!z10) {
                if (focusFinder.findNextFocus(this, view, !((this.f1598y.I() != 1) ^ (i10 != 2)) ? 66 : 17) != null) {
                }
            }
            if (z10) {
            }
            viewA0 = focusFinder.findNextFocus(this, view, i10);
        } else {
            z10 = false;
            if (!z10 && this.f1598y.e()) {
                z10 = focusFinder.findNextFocus(this, view, !((this.f1598y.I() != 1) ^ (i10 != 2)) ? 66 : 17) != null;
            }
            if (z10) {
                n();
                if (C(view) == null) {
                ...
                j0();
                this.f1598y.a0(view, i10, this.f1583n, this.f1594t0);
                l0(false);
            }
            viewA0 = focusFinder.findNextFocus(this, view, i10);
        }
        ...
        if (viewA0 == null || viewA0 == this || viewA0 == view) {
            z11 = false;
        } else if (C(viewA0) == null) {
            z11 = false;
        } else if (view != null && C(view) != null) {
            this.u.set(0, 0, view.getWidth(), view.getHeight());
            this.f1595v.set(0, 0, viewA0.getWidth(), viewA0.getHeight());
            offsetDescendantRectToMyCoords(view, this.u);
            offsetDescendantRectToMyCoords(viewA0, this.f1595v);
            int i12 = this.f1598y.I() == 1 ? -1 : 1;
            Rect rect = this.u;
            int i13 = rect.left;
            Rect rect2 = this.f1595v;
            int i14 = rect2.left;
        ...
        return z11 ? viewA0 : super.focusSearch(view, i10);
    }
    ...
    */
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        float axisValue;
        n nVar;
        if (this.f1598y != null && !this.J && motionEvent.getAction() == 8) {
            if ((motionEvent.getSource() & 2) != 0) {
                f6 = this.f1598y.f() ? -motionEvent.getAxisValue(9) : 0.0f;
                axisValue = this.f1598y.e() ? motionEvent.getAxisValue(10) : 0.0f;
                if (f6 != 0.0f || axisValue != 0.0f) {
                    int i10 = (int) (axisValue * this.f1584n0);
                    int i11 = (int) (f6 * this.f1586o0);
                    nVar = this.f1598y;
                    if (nVar != null) {
                        ...
                        k0(zF ? (zE ? 1 : 0) | 2 : zE ? 1 : 0, 1);
                        if (t(zE ? i10 : 0, zF ? i11 : 0, this.G0, this.E0, 1)) {
                            int[] iArr2 = this.G0;
                            i10 -= iArr2[0];
                            i11 -= iArr2[1];
                        }
                        d0(zE ? i10 : 0, zF ? i11 : 0, motionEvent, 1);
                        androidx.recyclerview.widget.k kVar = this.f1590r0;
                ...
                if (this.f1598y.f()) {
                    f6 = -axisValue2;
                    if (f6 != 0.0f) {
                        int i102 = (int) (axisValue * this.f1584n0);
                        int i112 = (int) (f6 * this.f1586o0);
                        nVar = this.f1598y;
                        if (nVar != null) {
                        }
                    }
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:193:0x02f7 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:216:0x0335 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:219:0x033a */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:233:0x03aa */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:57:0x00f8 */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    */
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            r55.f1573d0 = motionEvent.getPointerId(0);
            int x10 = (int) (motionEvent.getX() + 0.5f);
            r55.f1577h0 = x10;
            r55.f1575f0 = x10;
            int y10 = (int) (motionEvent.getY() + 0.5f);
            ...
            if (actionMasked == 1) {
                this.f1574e0.addMovement(motionEventObtain);
                this.f1574e0.computeCurrentVelocity(1000, this.f1582m0);
                float f6 = zE ? -this.f1574e0.getXVelocity(this.f1573d0) : 0.0f;
                float f10 = zF ? -this.f1574e0.getYVelocity(this.f1573d0) : 0.0f;
                if (f6 != 0.0f || f10 != 0.0f) {
                    int i12 = (int) f6;
                    int i13 = (int) f10;
                    n nVar2 = this.f1598y;
                    if (nVar2 != null) {
                        if (!this.J) {
                            boolean zE2 = nVar2.e();
                            boolean zF2 = this.f1598y.f();
                            if (!zE2 || Math.abs(i12) < this.f1581l0) {
                                i12 = 0;
                            }
                            if (!zF2 || Math.abs(i13) < this.f1581l0) {
                                i13 = 0;
                            }
                            if (i12 != 0 || i13 != 0) {
                                float f11 = i12;
                                ...
                                if (dispatchNestedPreFling(f11, f12)) {
                                    ...
                                    dispatchNestedFling(f11, f12, z16);
                                    q qVar = this.f1580k0;
                                    if (qVar != null) {
                                        androidx.recyclerview.widget.y yVar = (androidx.recyclerview.widget.y) qVar;
                                        ?? layoutManager = yVar.f1878a.getLayoutManager();
                                        if (layoutManager == 0 || yVar.f1878a.getAdapter() == null) {
                                            r21 = zE2;
                                            z10 = zF2;
                                            motionEvent2 = motionEventObtain;
                                        } else {
                                            int minFlingVelocity = yVar.f1878a.getMinFlingVelocity();
                                            if (Math.abs(i13) > minFlingVelocity || Math.abs(i12) > minFlingVelocity) {
                                                boolean z17 = layoutManager instanceof y.b;
                                                if (z17) {
                                                    ?? r56 = (androidx.recyclerview.widget.s) yVar;
                                                    androidx.recyclerview.widget.r rVar2 = z17 ? new androidx.recyclerview.widget.r(r56, r56.f1878a.getContext()) : null;
                                                    if (rVar2 != null) {
                                                        int iH = layoutManager.H();
                                                        if (iH != 0) {
                                                            androidx.recyclerview.widget.q qVarH = layoutManager.f() ? r56.h(layoutManager) : layoutManager.e() ? r56.g(layoutManager) : null;
                                                            if (qVarH == null) {
                                                                z12 = zE2;
                                                                z10 = zF2;
                                                                motionEvent2 = motionEventObtain;
                                                                ...
                                                                while (i16 < iX) {
                                                                    int i17 = iX;
                                                                    View viewW = layoutManager.w(i16);
                                                                    if (viewW == null) {
                                                                        z14 = zF2;
                                                                    } else {
                                                                        z14 = zF2;
                                                                        int iE = r56.e(viewW, qVarH);
                                                                        if (iE <= 0 && iE > i14) {
                                                                            i14 = iE;
                                                                            view = viewW;
                                                                        }
                                                                ...
                                                                z10 = zF2;
                                                                boolean z18 = !layoutManager.e() ? i13 <= 0 : i12 <= 0;
                                                                if (z18 && view2 != null) {
                                                                    iP = layoutManager.P(view2);
                                                                    z13 = z12;
                                                                } else if (z18 || view == null) {
                                                                    if (z18) {
                                                                        view2 = view;
                                                                    }
                                                                    if (view2 != null) {
                                                                        iP = ((z17 && (pointFA = ((y.b) layoutManager).a(layoutManager.H() + (-1))) != null && ((pointFA.x > 0.0f ? 1 : (pointFA.x == 0.0f ? 0 : -1)) < 0 || (pointFA.y > 0.0f ? 1 : (pointFA.y == 0.0f ? 0 : -1)) < 0)) == z18 ? -1 : 1) + layoutManager.P(view2);
                                                                        z13 = z12;
                                                                        if (iP < 0 || iP >= iH) {
                                                                        }
                                                                    }
                                                                } else {
                                                                    iP = layoutManager.P(view);
                                                                    z13 = z12;
                                                                }
                                                                if (iP != -1) {
                                                                    i11 = 0;
                                    ...
                                    if (z16) {
                                        ?? r57 = this;
                                        r57.k0(z10 ? r21 | 2 : r21, 1);
                                        int i18 = r57.f1582m0;
                                        int iMax = Math.max(-i18, Math.min(i12, i18));
                                        int i19 = r57.f1582m0;
                                        int iMax2 = Math.max(-i19, Math.min(i13, i19));
                                        b0 b0Var = r57.f1588q0;
                                        RecyclerView.this.setScrollState(2);
                                        b0Var.f1601n = 0;
                                        b0Var.m = 0;
                                        Interpolator interpolator = b0Var.p;
                                        Interpolator interpolator2 = P0;
                                        if (interpolator != interpolator2) {
                                            b0Var.p = interpolator2;
                                            b0Var.f1602o = new OverScroller(RecyclerView.this.getContext(), interpolator2);
                                        }
                                        b0Var.f1602o.fling(0, 0, iMax, iMax2, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
                                        b0Var.a();
                                        i11 = 1;
                                        r54 = r57;
                                    } else {
            ...
            if (actionMasked == 2) {
                ...
                int x11 = (int) (motionEvent.getX(iFindPointerIndex) + 0.5f);
                int y11 = (int) (motionEvent.getY(iFindPointerIndex) + 0.5f);
                int iMax3 = this.f1577h0 - x11;
                int iMax4 = this.f1578i0 - y11;
                if (this.f1572c0 != 1) {
                    if (zE) {
                        iMax3 = iMax3 > 0 ? Math.max(0, iMax3 - this.f1579j0) : Math.min(0, iMax3 + this.f1579j0);
                        if (iMax3 != 0) {
                            z15 = true;
                        }
                        if (zF) {
                        ...
                        z15 = false;
                        if (zF) {
                            iMax4 = iMax4 > 0 ? Math.max(0, iMax4 - this.f1579j0) : Math.min(0, iMax4 + this.f1579j0);
                            if (iMax4 != 0) {
                                z15 = true;
                            }
                        }
                    ...
                    if (i10 == 0) {
                        ...
                        r52.f1574e0.addMovement(motionEvent3);
                    } else {
                        motionEvent3 = motionEvent2;
                    }
                    motionEvent3.recycle();
                ...
                if (this.f1572c0 == 1) {
                    ...
                    iArr3[0] = 0;
                    iArr3[1] = 0;
                    if (t(zE ? i20 : 0, zF ? i21 : 0, iArr3, this.E0, 0)) {
                        int[] iArr4 = this.G0;
                        i20 -= iArr4[0];
                        i21 -= iArr4[1];
                        int[] iArr5 = this.F0;
                    ...
                    int i23 = i21;
                    int[] iArr7 = this.E0;
                    this.f1577h0 = x11 - iArr7[0];
                    this.f1578i0 = y11 - iArr7[1];
                    if (d0(zE ? i20 : 0, zF ? i23 : 0, motionEvent, 0)) {
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
                    androidx.recyclerview.widget.k kVar = this.f1590r0;
                    if (kVar != null && (i20 != 0 || i23 != 0)) {
                        kVar.a(this, i20, i23);
                    }
                }
            } else if (actionMasked == 3) {
    ...
    */
    public void q() {
        ...
        this.f1594t0.f1701i = false;
        boolean z11 = true;
        boolean z12 = this.J0 && !(this.K0 == getWidth() && this.L0 == getHeight());
        this.K0 = 0;
        this.L0 = 0;
        this.J0 = false;
        if (this.f1594t0.f1696d == 1) {
            ...
            androidx.recyclerview.widget.a aVar = this.p;
            if (((aVar.f1741c.isEmpty() || aVar.f1740b.isEmpty()) ? false : true) || z12 || this.f1598y.f1650n != getWidth() || this.f1598y.f1651o != getHeight()) {
                this.f1598y.A0(this);
                s();
            } else {
                this.f1598y.A0(this);
        ...
        View view2 = null;
        if (zVar.f1702j) {
            int iE = this.f1587q.e() - 1;
            while (iE >= 0) {
                c0 c0VarK2 = K(this.f1587q.d(iE));
                if (!c0VarK2.u()) {
                    long jI = I(c0VarK2);
                    Objects.requireNonNull(this.f1571b0);
                    k.c cVar = new k.c();
                    View view3 = c0VarK2.f1607a;
                    cVar.f1635a = view3.getLeft();
                    cVar.f1636b = view3.getTop();
                    view3.getRight();
                    view3.getBottom();
                    c0 c0VarF = this.f1589r.f1750b.f(jI, null);
                    if (c0VarF == null || c0VarF.u()) {
                        this.f1589r.b(c0VarK2, cVar);
                    } else {
                        boolean zD = this.f1589r.d(c0VarF);
                        boolean zD2 = this.f1589r.d(c0VarK2);
                        if (zD && c0VarF == c0VarK2) {
                            this.f1589r.b(c0VarK2, cVar);
                        } else {
                            k.c cVarE = this.f1589r.e(c0VarF, i10);
                            this.f1589r.b(c0VarK2, cVar);
                            k.c cVarE2 = this.f1589r.e(c0VarK2, 8);
                            if (cVarE == null) {
                                int iE2 = this.f1587q.e();
                                for (int i11 = 0; i11 < iE2; i11++) {
                                    c0 c0VarK3 = K(this.f1587q.d(i11));
                                    if (c0VarK3 != c0VarK2 && I(c0VarK3) == jI) {
                                        f fVar = this.f1597x;
                                        if (fVar == null || !fVar.f1627b) {
                                            StringBuilder sb2 = new StringBuilder();
                                            ...
                                            sb2.append(" \n View Holder 2:");
                                            sb2.append(c0VarK2);
                                            throw new IllegalStateException(r8.g.b(this, sb2));
                                        }
                                        StringBuilder sb3 = new StringBuilder();
                                        ...
                                        sb3.append(" \n View Holder 2:");
                                        sb3.append(c0VarK2);
                                        throw new IllegalStateException(r8.g.b(this, sb3));
                                    }
                                }
                                Log.e("RecyclerView", "Problem while matching changed view holders with the newones. The pre-layout information for the change holder " + c0VarF + " cannot be found but it is necessary for " + c0VarK2 + A());
                            } else {
                                c0VarF.t(false);
                                if (zD) {
                                    f(c0VarF);
                                ...
                                if (c0VarF != c0VarK2) {
                                    ...
                                    c0VarF.f1614h = c0VarK2;
                                    f(c0VarF);
                                    this.f1583n.k(c0VarF);
                                    c0VarK2.t(false);
                                    c0VarK2.f1615i = c0VarF;
                                }
                                if (this.f1571b0.b(c0VarF, c0VarK2, cVarE, cVarE2)) {
                                    W();
                                }
                            }
                        }
            ...
            androidx.recyclerview.widget.a0 a0Var = this.f1589r;
            a0.b bVar = this.M0;
            for (int i12 = a0Var.f1749a.f9431o - 1; i12 >= 0; i12--) {
                c0 c0VarH = a0Var.f1749a.h(i12);
                a0.a aVarI = a0Var.f1749a.i(i12);
                int i13 = aVarI.f1752a;
                if ((i13 & 3) == 3) {
                    RecyclerView recyclerView = RecyclerView.this;
                    recyclerView.f1598y.s0(c0VarH.f1607a, recyclerView.f1583n);
                } else if ((i13 & 1) != 0) {
                    k.c cVar2 = aVarI.f1753b;
                    if (cVar2 == null) {
                        RecyclerView recyclerView2 = RecyclerView.this;
                        recyclerView2.f1598y.s0(c0VarH.f1607a, recyclerView2.f1583n);
                    } else {
                        ((d) bVar).a(c0VarH, cVar2, aVarI.f1754c);
                    }
                } else if ((i13 & 14) == 14) {
                    k.c cVar3 = aVarI.f1753b;
                    k.c cVar4 = aVarI.f1754c;
                    RecyclerView recyclerView3 = RecyclerView.this;
                    Objects.requireNonNull(recyclerView3);
                    c0VarH.t(false);
                    if (recyclerView3.f1571b0.a(c0VarH, cVar3, cVar4)) {
                        recyclerView3.W();
                    }
                } else if ((i13 & 12) == 12) {
                    k.c cVar5 = aVarI.f1753b;
                    k.c cVar6 = aVarI.f1754c;
                    d dVar = (d) bVar;
                    Objects.requireNonNull(dVar);
                    c0VarH.t(false);
                    RecyclerView recyclerView4 = RecyclerView.this;
                    if (recyclerView4.P) {
                        if (recyclerView4.f1571b0.b(c0VarH, c0VarH, cVar5, cVar6)) {
                            RecyclerView.this.W();
                        }
                    } else if (recyclerView4.f1571b0.d(c0VarH, cVar5, cVar6)) {
                        RecyclerView.this.W();
                    }
                } else if ((i13 & 4) != 0) {
                    ((d) bVar).a(c0VarH, aVarI.f1753b, null);
                } else if ((i13 & 8) != 0) {
                    k.c cVar7 = aVarI.f1753b;
                    k.c cVar8 = aVarI.f1754c;
                    RecyclerView recyclerView5 = RecyclerView.this;
                    Objects.requireNonNull(recyclerView5);
                    c0VarH.t(false);
                    if (recyclerView5.f1571b0.a(c0VarH, cVar7, cVar8)) {
                        recyclerView5.W();
                    }
                }
                a0.a.b(aVarI);
        ...
        zVar2.f1694b = zVar2.f1697e;
        this.P = false;
        this.Q = false;
        zVar2.f1702j = false;
        zVar2.f1703k = false;
        this.f1598y.f1643f = false;
        ArrayList<c0> arrayList = this.f1583n.f1669b;
        if (arrayList != null) {
            arrayList.clear();
        }
        n nVar = this.f1598y;
        ...
        this.f1598y.l0(this.f1594t0);
        U(true);
        l0(false);
        androidx.recyclerview.widget.a0 a0Var2 = this.f1589r;
        a0Var2.f1749a.clear();
        a0Var2.f1750b.a();
        int[] iArr = this.C0;
        int i14 = iArr[0];
        ...
        if (this.p0 && this.f1597x != null && hasFocus() && getDescendantFocusability() != 393216 && (getDescendantFocusability() != 131072 || !isFocused())) {
            if (!isFocused()) {
                if (this.f1587q.k(getFocusedChild())) {
                    long j10 = this.f1594t0.m;
                    if (j10 == -1 || !(z10 = this.f1597x.f1627b)) {
                        c0VarK = null;
                    } else {
                        if (z10) {
                            int iH = this.f1587q.h();
                            ...
                            for (int i16 = 0; i16 < iH; i16++) {
                                c0VarK = K(this.f1587q.g(i16));
                                if (c0VarK != null && !c0VarK.m() && c0VarK.f1611e == j10) {
                                    if (!this.f1587q.k(c0VarK.f1607a)) {
                                        break;
                                    } else {
                                        c0Var = c0VarK;
                    ...
                    if (c0VarK != null && !this.f1587q.k(c0VarK.f1607a) && c0VarK.f1607a.hasFocusable()) {
                        view2 = c0VarK.f1607a;
                    } else if (this.f1587q.e() > 0) {
                        z zVar3 = this.f1594t0;
                        int i17 = zVar3.f1704l;
                        int i18 = i17 != -1 ? i17 : 0;
                        int iB = zVar3.b();
                        for (int i19 = i18; i19 < iB; i19++) {
                            c0 c0VarG = G(i19);
                            if (c0VarG == null) {
                                break;
                            }
                            if (c0VarG.f1607a.hasFocusable()) {
                                view = c0VarG.f1607a;
                                break;
                            }
                        }
                        for (int iMin = Math.min(iB, i18) - 1; iMin >= 0; iMin--) {
                            c0 c0VarG2 = G(iMin);
                            if (c0VarG2 == null) {
                                break;
                            }
                            if (c0VarG2.f1607a.hasFocusable()) {
                                view = c0VarG2.f1607a;
                                view2 = view;
                            }
                        }
                    ...
                    if (view2 != null) {
                        int i20 = this.f1594t0.f1705n;
                        if (i20 != -1 && (viewFindViewById = view2.findViewById(i20)) != null && viewFindViewById.isFocusable()) {
    ...
    */
    public final void r() {
        ...
        T();
        X();
        View focusedChild = (this.p0 && hasFocus() && this.f1597x != null) ? getFocusedChild() : null;
        c0 c0VarJ = (focusedChild == null || (viewC = C(focusedChild)) == null) ? null : J(viewC);
        if (c0VarJ == null) {
            z zVar = this.f1594t0;
            zVar.m = -1L;
            zVar.f1704l = -1;
            ...
            z zVar2 = this.f1594t0;
            zVar2.m = this.f1597x.f1627b ? c0VarJ.f1611e : -1L;
            if (!this.P) {
                if (c0VarJ.m()) {
                    iH = c0VarJ.f1610d;
                } else {
                    RecyclerView recyclerView = c0VarJ.f1622r;
                    iH = recyclerView == null ? -1 : recyclerView.H(c0VarJ);
                }
                zVar2.f1704l = iH;
                z zVar3 = this.f1594t0;
                View focusedChild2 = c0VarJ.f1607a;
        ...
        z zVar4 = this.f1594t0;
        zVar4.f1700h = zVar4.f1702j && this.x0;
        this.x0 = false;
        this.w0 = false;
        zVar4.f1699g = zVar4.f1703k;
        zVar4.f1697e = this.f1597x.a();
        E(this.C0);
        if (this.f1594t0.f1702j) {
            int iE = this.f1587q.e();
            for (int i10 = 0; i10 < iE; i10++) {
                c0 c0VarK = K(this.f1587q.d(i10));
                if (!c0VarK.u() && (!c0VarK.k() || this.f1597x.f1627b)) {
                    k kVar = this.f1571b0;
                    k.e(c0VarK);
                    c0VarK.g();
                    this.f1589r.c(c0VarK, kVar.l(c0VarK));
                    if (this.f1594t0.f1700h && c0VarK.p() && !c0VarK.m() && !c0VarK.u() && !c0VarK.k()) {
                        this.f1589r.f1750b.g(I(c0VarK), c0VarK);
                    }
                }
            }
        }
        if (this.f1594t0.f1703k) {
            int iH2 = this.f1587q.h();
            for (int i11 = 0; i11 < iH2; i11++) {
                c0 c0VarK2 = K(this.f1587q.g(i11));
                if (!c0VarK2.u() && c0VarK2.f1610d == -1) {
                    c0VarK2.f1610d = c0VarK2.f1609c;
                }
            }
            z zVar5 = this.f1594t0;
            boolean z10 = zVar5.f1698f;
            zVar5.f1698f = false;
            this.f1598y.k0(this.f1583n, zVar5);
            this.f1594t0.f1698f = z10;
            for (int i12 = 0; i12 < this.f1587q.e(); i12++) {
                c0 c0VarK3 = K(this.f1587q.d(i12));
                if (!c0VarK3.u()) {
                    a0.a orDefault = this.f1589r.f1749a.getOrDefault(c0VarK3, null);
                    if (!((orDefault == null || (orDefault.f1752a & 4) == 0) ? false : true)) {
                        k.e(c0VarK3);
                        boolean zH = c0VarK3.h(8192);
                        k kVar2 = this.f1571b0;
                        c0VarK3.g();
                        k.c cVarL = kVar2.l(c0VarK3);
                        if (zH) {
                            Z(c0VarK3, cVarL);
                        } else {
                            androidx.recyclerview.widget.a0 a0Var2 = this.f1589r;
                            a0.a orDefault2 = a0Var2.f1749a.getOrDefault(c0VarK3, null);
                            if (orDefault2 == null) {
                                orDefault2 = a0.a.a();
                                a0Var2.f1749a.put(c0VarK3, orDefault2);
                            }
                            orDefault2.f1752a |= 2;
                            orDefault2.f1753b = cVarL;
                        }
                    }
                }
            }
