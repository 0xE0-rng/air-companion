...
public class z extends Spinner {
    ...
    */
    public z(Context context, AttributeSet attributeSet, int i10) throws Throwable {
        Exception e10;
        ...
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, t.c.G, i10, 0);
        this.m = new androidx.appcompat.widget.f(this);
        int resourceId = typedArrayObtainStyledAttributes2.getResourceId(4, 0);
        if (resourceId != 0) {
            this.f789n = new i.c(context, resourceId);
        } else {
            this.f789n = context;
        }
        ...
        try {
            try {
                typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, u, i10, 0);
                try {
                    ...
                    this.f791q = true;
                    spinnerAdapter = this.p;
                    if (spinnerAdapter != null) {
                    }
                    this.m.d(attributeSet, i10);
                }
            } catch (Throwable th) {
                th = th;
                typedArray = typedArrayObtainStyledAttributes;
        ...
        if (i11 != 0) {
            b bVar = new b();
            this.f792r = bVar;
            bVar.h(typedArrayObtainStyledAttributes2.getString(2));
        } else if (i11 == 1) {
            d dVar = new d(this.f789n, attributeSet, i10);
            g1 g1VarR = g1.r(this.f789n, attributeSet, t.c.G, i10, 0);
            this.f793s = g1VarR.l(3, -2);
            dVar.K.setBackgroundDrawable(g1VarR.g(1));
            dVar.L = typedArrayObtainStyledAttributes2.getString(2);
            g1VarR.f651b.recycle();
            this.f792r = dVar;
            this.f790o = new y(this, this, dVar);
        }
        textArray = typedArrayObtainStyledAttributes2.getTextArray(0);
        if (textArray != null) {
            ArrayAdapter arrayAdapter = new ArrayAdapter(context, R.layout.simple_spinner_item, textArray);
            arrayAdapter.setDropDownViewResource(de.com.ideal.airpro.R.layout.support_simple_spinner_dropdown_item);
