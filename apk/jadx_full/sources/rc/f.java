...
public final class f extends rc.d implements l {
    ...
    public final class a implements rb.m<ua.p, StringBuilder> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r13v0, resolved type: rb.j */
        /* JADX DEBUG: Return type fixed from 'java.lang.Object' to match base method */
        ...
        */
        public ua.p f(rb.j jVar, StringBuilder sb2) throws IOException {
            boolean z10;
            rb.d dVarA0;
            StringBuilder sb3 = sb2;
            y.f(sb3, "builder");
            f fVar = f.this;
            fVar.R(sb3, jVar, null);
            m mVar = fVar.f11034d;
            gb.b bVar = mVar.f11060o;
            kb.i<?>[] iVarArr = m.W;
            if (!((Boolean) bVar.b(mVar, iVarArr[13])).booleanValue()) {
                rb.e eVarR = ((ub.i) jVar).R();
                y.e(eVarR, "constructor.constructedClass");
                if (eVarR.n() != u.SEALED) {
                    v0 v0VarH = ((ub.r) jVar).h();
                    y.e(v0VarH, "constructor.visibility");
                    z10 = fVar.v0(v0VarH, sb3);
                }
            }
            fVar.Y(jVar, sb3);
            m mVar2 = fVar.f11034d;
            boolean z11 = ((Boolean) mVar2.O.b(mVar2, iVarArr[39])).booleanValue() || !((ub.i) jVar).P || z10;
            if (z11) {
                sb3.append(fVar.X("constructor"));
            }
            ub.i iVar = (ub.i) jVar;
            rb.e eVarC = iVar.c();
            y.e(eVarC, "constructor.containingDeclaration");
            if (fVar.H()) {
                if (z11) {
                    sb3.append(" ");
                }
                fVar.e0(eVarC, sb3, true);
                fVar.r0(((ub.r) jVar).B(), sb3, false);
            }
            ub.r rVar = (ub.r) jVar;
            List<s0> listK = rVar.k();
            y.e(listK, "constructor.valueParameters");
            fVar.u0(listK, jVar.a0(), sb3);
            m mVar3 = fVar.f11034d;
            if (((Boolean) mVar3.f11061q.b(mVar3, iVarArr[15])).booleanValue() && !iVar.P && (dVarA0 = eVarC.A0()) != null) {
                List<s0> listK2 = dVarA0.k();
                ArrayList arrayListB = a0.b(listK2, "primaryConstructor.valueParameters");
                for (Object obj : listK2) {
                    s0 s0Var = (s0) obj;
                    if (!s0Var.k0() && s0Var.P() == null) {
                        arrayListB.add(obj);
                    }
                }
                if (!arrayListB.isEmpty()) {
                    sb3.append(" : ");
                    sb3.append(fVar.X("this"));
                    sb3.append(va.l.Y0(arrayListB, ", ", "(", ")", 0, null, i.f11045n, 24));
                }
            }
            if (fVar.H()) {
                fVar.w0(rVar.B(), sb3);
        ...
        /* JADX DEBUG: Return type fixed from 'java.lang.Object' to match base method */
        @Override // rb.m
        public ua.p i(rb.a0 a0Var, StringBuilder sb2) {
            StringBuilder sb3 = sb2;
            y.f(sb3, "builder");
            f fVar = f.this;
            Objects.requireNonNull(fVar);
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: rb.g0 */
        /* JADX DEBUG: Return type fixed from 'java.lang.Object' to match base method */
        /* JADX WARN: Multi-variable type inference failed */
        @Override // rb.m
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public void n(rb.r rVar, StringBuilder sb2) throws IOException {
            boolean z10;
            boolean z11;
            y.f(rVar, "descriptor");
            y.f(sb2, "builder");
            ...
            if (!fVar.J()) {
                if (!fVar.I()) {
                    fVar.R(sb2, rVar, null);
                    v0 v0VarH = rVar.h();
                    y.e(v0VarH, "function.visibility");
                    fVar.v0(v0VarH, sb2);
                    fVar.c0(rVar, sb2);
                    if (fVar.F()) {
                        fVar.Z(rVar, sb2);
                    ...
                    if (fVar.F()) {
                        boolean z12 = false;
                        if (rVar.w0()) {
                            Collection<? extends rb.r> collectionG = rVar.g();
                            y.e(collectionG, "functionDescriptor.overriddenDescriptors");
                            if (collectionG.isEmpty()) {
                                z11 = true;
                                boolean z13 = !z11 || fVar.C();
                                if (rVar.P0()) {
                                    Collection<? extends rb.r> collectionG2 = rVar.g();
                                    y.e(collectionG2, "functionDescriptor.overriddenDescriptors");
                                    if (collectionG2.isEmpty()) {
                                        z10 = true;
                                        if (!z10 || fVar.C()) {
                                            z12 = true;
                                        }
                                    } else {
                                        for (rb.r rVar2 : collectionG2) {
                                            y.e(rVar2, "it");
                                            if (rVar2.P0()) {
                                                z10 = false;
                                                break;
                                ...
                                fVar.d0(sb2, rVar.v0(), "tailrec");
                                fVar.d0(sb2, rVar.s0(), "suspend");
                                fVar.d0(sb2, rVar.w(), "inline");
                                fVar.d0(sb2, z12, "infix");
                                fVar.d0(sb2, z13, "operator");
                            } else {
                                for (rb.r rVar3 : collectionG) {
                                    y.e(rVar3, "it");
                                    if (rVar3.w0()) {
                                        z11 = false;
                                        break;
                ...
                sb2.append(fVar.X("fun"));
                sb2.append(" ");
                List<p0> listB = rVar.B();
                y.e(listB, "function.typeParameters");
                fVar.r0(listB, sb2, true);
                fVar.k0(rVar, sb2);
            }
            fVar.e0(rVar, sb2, true);
            List<s0> listK = rVar.k();
            y.e(listK, "function.valueParameters");
            fVar.u0(listK, rVar.a0(), sb2);
            fVar.l0(rVar, sb2);
            gd.e0 e0VarI = rVar.i();
            m mVar = fVar.f11034d;
            gb.b bVar = mVar.f11058l;
            kb.i<?>[] iVarArr = m.W;
            if (!((Boolean) bVar.b(mVar, iVarArr[10])).booleanValue()) {
                m mVar2 = fVar.f11034d;
                if (((Boolean) mVar2.f11057k.b(mVar2, iVarArr[9])).booleanValue() || e0VarI == null || !ob.g.O(e0VarI)) {
                    sb2.append(": ");
                    sb2.append(e0VarI == null ? "[NULL]" : fVar.w(e0VarI));
                }
            }
            List<p0> listB2 = rVar.B();
            y.e(listB2, "function.typeParameters");
            fVar.w0(listB2, sb2);
        }
    ...
    */
    public final boolean A(String str, String str2) {
        if (!y.a(str, qd.j.w(str2, "?", "", false, 4))) {
            if (qd.j.q(str2, "?", false, 2)) {
                if (!y.a(str + '?', str2)) {
                    if (!y.a('(' + str + ")?", str2)) {
                        return false;
                    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void V(StringBuilder sb2, gd.e0 e0Var) {
        R(sb2, e0Var, null);
        if (!androidx.navigation.fragment.b.v(e0Var)) {
            gd.v0 v0VarY0 = e0Var.Y0();
            rb.h hVarX = e0Var.Y0().x();
            androidx.navigation.i iVarA = q0.a(e0Var, (rb.i) (hVarX instanceof rb.i ? hVarX : null), 0);
            if (iVarA == null) {
                sb2.append(o0(v0VarY0));
                sb2.append(n0(e0Var.X0()));
            } else {
                j0(sb2, iVarA);
            }
        } else if (e0Var instanceof h1) {
            m mVar = this.f11034d;
            if (((Boolean) mVar.T.b(mVar, m.W[45])).booleanValue()) {
                sb2.append(((h1) e0Var).f6815s);
            } else if (e0Var instanceof w) {
                m mVar2 = this.f11034d;
                if (((Boolean) mVar2.V.b(mVar2, m.W[47])).booleanValue()) {
                    sb2.append(e0Var.Y0().toString());
                } else {
                    sb2.append(((w) e0Var).h1());
                }
            }
            sb2.append(n0(e0Var.X0()));
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void g0(StringBuilder sb2, gd.e0 e0Var) {
        String strEscape;
        oc.e eVarC;
        if ((e0Var instanceof k1) && m() && !((k1) e0Var).d1()) {
            sb2.append("<Not computed yet>");
            return;
        }
        i1 i1VarB1 = e0Var.b1();
        if (i1VarB1 instanceof gd.y) {
            sb2.append(((gd.y) i1VarB1).g1(this, this));
            return;
        }
        if (i1VarB1 instanceof l0) {
            l0 l0Var = (l0) i1VarB1;
            if (!y.a(l0Var, f1.f6801b)) {
                if (!(l0Var != null && l0Var.Y0() == ((w) f1.f6800a).f6857n)) {
                    if (l0Var != null && (l0Var.Y0() instanceof x.f)) {
                        m mVar = this.f11034d;
                        if (!((Boolean) mVar.f11064t.b(mVar, m.W[18])).booleanValue()) {
                            sb2.append("???");
                            return;
                        }
                        gd.v0 v0VarY0 = l0Var.Y0();
                        Objects.requireNonNull(v0VarY0, "null cannot be cast to non-null type org.jetbrains.kotlin.types.ErrorUtils.UninferredParameterTypeConstructor");
                        x.f.a(1);
                        throw null;
                    }
                    ...
                    ((f) this.f11033c.getValue()).R(sb2, l0Var, null);
                    boolean z10 = sb2.length() != length;
                    boolean zI = ob.f.i(l0Var);
                    boolean zZ0 = l0Var.Z0();
                    gd.e0 e0VarE = ob.f.e(l0Var);
                    boolean z11 = zZ0 || (z10 && e0VarE != null);
                    if (z11) {
                        if (zI) {
                            sb2.insert(length, '(');
                        } else {
                            if (z10) {
                                ...
                                sb2.charAt(qd.n.D(sb2));
                                if (sb2.charAt(qd.n.D(sb2) - 1) != ')') {
                                    sb2.insert(qd.n.D(sb2), "()");
                                }
                            }
                            sb2.append("(");
                        }
                    ...
                    d0(sb2, zI, "suspend");
                    if (e0VarE != null) {
                        if (!y0(e0VarE) || e0VarE.Z0()) {
                            boolean z12 = ob.f.i(e0VarE) || !e0VarE.s().isEmpty();
                            if (z12) {
                                sb2.append("(");
                            }
                            f0(sb2, e0VarE);
                    ...
                    sb2.append("(");
                    int i10 = 0;
                    for (y0 y0Var : ob.f.g(l0Var)) {
                        if (i10 > 0) {
                            sb2.append(", ");
                        }
                        m mVar2 = this.f11034d;
                        if (((Boolean) mVar2.S.b(mVar2, m.W[43])).booleanValue()) {
    ...
    public String q(rb.k kVar) {
        ...
        kb.i<?>[] iVarArr = m.W;
        if (((Boolean) bVar.b(mVar, iVarArr[1])).booleanValue() && !(kVar instanceof rb.x) && !(kVar instanceof rb.a0)) {
            if (kVar instanceof v) {
                ...
                if (kVarC != null && !(kVarC instanceof v)) {
                    ...
                    m mVar2 = this.f11034d;
                    if (((Boolean) mVar2.f11050d.b(mVar2, iVarArr[2])).booleanValue() && (kVarC instanceof rb.x) && (kVar instanceof rb.n)) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void t0(s0 s0Var, boolean z10, StringBuilder sb2, boolean z11) {
        boolean z12;
        if (z11) {
            sb2.append(X("value-parameter"));
            sb2.append(" ");
        }
        if (M()) {
            sb2.append("/*");
        ...
        R(sb2, s0Var, null);
        d0(sb2, s0Var.D(), "crossinline");
        d0(sb2, s0Var.K0(), "noinline");
        m mVar = this.f11034d;
        gb.b bVar = mVar.f11062r;
        kb.i<?>[] iVarArr = m.W;
        boolean zBooleanValue = ((Boolean) bVar.b(mVar, iVarArr[16])).booleanValue();
        boolean z13 = false;
        if (zBooleanValue) {
            rb.a aVarC = s0Var.c();
            rb.d dVar = (rb.d) (aVarC instanceof rb.d ? aVarC : null);
            z12 = dVar != null && dVar.Q();
        }
        if (z12) {
            m mVar2 = this.f11034d;
            d0(sb2, ((Boolean) mVar2.f11063s.b(mVar2, iVarArr[17])).booleanValue(), "actual");
        }
        gd.e0 e0VarD = s0Var.d();
        y.e(e0VarD, "variable.type");
        gd.e0 e0VarP = s0Var.P();
        gd.e0 e0Var = e0VarP != null ? e0VarP : e0VarD;
        d0(sb2, e0VarP != null, "vararg");
        if (z12 || (z11 && !J())) {
            s0(s0Var, sb2, z12);
        }
        if (z10) {
        ...
        m mVar3 = this.f11034d;
        if (((db.l) mVar3.f11067y.b(mVar3, iVarArr[23])) != null) {
            if (m() ? s0Var.k0() : wc.b.a(s0Var)) {
                z13 = true;
            }
        }
        if (z13) {
            ...
            m mVar4 = this.f11034d;
            db.l lVar = (db.l) mVar4.f11067y.b(mVar4, iVarArr[23]);
            y.d(lVar);
            sbB.append((String) lVar.b(s0Var));
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void u0(Collection<? extends s0> collection, boolean z10, StringBuilder sb2) {
        boolean z11;
        m mVar = this.f11034d;
        int i10 = g.f11043e[((r) mVar.D.b(mVar, m.W[28])).ordinal()];
        if (i10 == 1) {
            z11 = true;
        } else {
            if (i10 != 2) {
        ...
        for (s0 s0Var : collection) {
            L().a(s0Var, i11, size, sb2);
            t0(s0Var, z11, sb2, false);
            L().c(s0Var, i11, size, sb2);
            i11++;
        }
        L().d(size, sb2);
    }
