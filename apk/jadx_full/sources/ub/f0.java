...
public class f0 extends d0 implements rb.e0 {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v10, resolved type: ub.f0 */
    /* JADX DEBUG: Multi-variable search result rejected for r1v8, resolved type: ub.f0 */
    /* JADX DEBUG: Multi-variable search result rejected for r1v9, resolved type: ub.f0 */
