...
public class e {
    ...
    */
    public final int d(r.f fVar, int i10) {
        long j10;
        int i11;
        e eVar = this;
        r.f fVar2 = fVar;
        int size = eVar.f11177h.size();
        long jMax = 0;
        int i12 = 0;
        long jMax2 = 0;
        while (i12 < size) {
            m mVar = eVar.f11177h.get(i12);
            p pVar = mVar.f11194a;
            if (pVar instanceof c) {
                if (((c) pVar).f11210f == i10) {
                    f fVar3 = (i10 == 0 ? fVar2.f10601d : fVar2.f10603e).f11212h;
                    f fVar4 = (i10 == 0 ? fVar2.f10601d : fVar2.f10603e).f11213i;
                    boolean zContains = pVar.f11212h.f11189l.contains(fVar3);
                    boolean zContains2 = mVar.f11194a.f11213i.f11189l.contains(fVar4);
                    long j11 = mVar.f11194a.j();
                    if (zContains && zContains2) {
                        long jB = mVar.b(mVar.f11194a.f11212h, jMax2);
                        long jA = mVar.a(mVar.f11194a.f11213i, jMax2);
                        long j12 = jB - j11;
                        p pVar2 = mVar.f11194a;
                        int i13 = pVar2.f11213i.f11183f;
                        if (j12 >= (-i13)) {
                            j12 += (long) i13;
                        }
                        long j13 = (-jA) - j11;
                        long j14 = pVar2.f11212h.f11183f;
                        long j15 = j13 - j14;
                        if (j15 >= j14) {
                            j15 -= j14;
                        }
                        r.e eVar2 = pVar2.f11206b;
                        Objects.requireNonNull(eVar2);
                        float f6 = i10 == 0 ? eVar2.Z : i10 == 1 ? eVar2.f10596a0 : -1.0f;
                        float f10 = f6 > 0.0f ? (long) ((j12 / (1.0f - f6)) + (j15 / f6)) : 0L;
                        long jA2 = ((long) ((f10 * f6) + 0.5f)) + j11 + ((long) d0.c.a(1.0f, f6, f10, 0.5f));
                        p pVar3 = mVar.f11194a;
                        j10 = ((long) pVar3.f11212h.f11183f) + jA2;
                        i11 = pVar3.f11213i.f11183f;
                    } else if (zContains) {
                        jMax2 = Math.max(mVar.b(mVar.f11194a.f11212h, r0.f11183f), ((long) mVar.f11194a.f11212h.f11183f) + j11);
                    } else if (zContains2) {
                        jMax2 = Math.max(-mVar.a(mVar.f11194a.f11213i, r0.f11183f), ((long) (-mVar.f11194a.f11213i.f11183f)) + j11);
                    } else {
                        p pVar4 = mVar.f11194a;
                        j10 = ((long) pVar4.f11212h.f11183f) + pVar4.j();
                        i11 = mVar.f11194a.f11213i.f11183f;
                    }
                    jMax2 = j10 - ((long) i11);
                }
            } else if (i10 == 0) {
