...
public final class kc {
    ...
    public static final SparseArray<Pair<String, String>> f13010a;
    ...
    */
    public static t6.e a(Status status) {
        int i10 = status.f2773n;
        Pair<String, String> pair = f13010a.get(i10);
        String strB = b(pair != null ? (String) pair.second : "An internal error has occurred.", status);
        if (i10 == 17020) {
            return new t6.g(b("A network error (such as timeout, interrupted connection or unreachable host) has occurred.", status));
        }
        if (i10 != 17021) {
            if (i10 != 17051) {
                if (i10 == 17052) {
                    return new t6.b(strB);
                }
                if (i10 != 17057 && i10 != 17058) {
                    if (i10 != 17000 && i10 != 17002 && i10 != 17049) {
                        if (i10 != 17068) {
                            if (i10 != 17077) {
                                if (i10 == 17495) {
                                    return new p7.a(b("Please sign in before trying to get a token.", status));
                                }
                                if (i10 == 17499) {
                                    return new t6.e(b("An internal error has occurred.", status));
                                }
                                if (i10 != 18001 && i10 != 17093) {
                                    if (i10 != 17094) {
                                        switch (i10) {
                                            case 17004:
                                            case 17008:
                                            ...
                                            case 17007:
                                            case 17012:
                                                return new x6.j(c(i10), strB);
                                            case 17010:
                                                return new t6.b(b("We have blocked all requests from this device due to unusual activity. Try again later.", status));
                                            default:
                                                switch (i10) {
                                                    case 17079:
                                                    case 17085:
                                                    ...
                                                    default:
                                                        switch (i10) {
                                                            case 17014:
                                                                return new x6.f(c(i10), strB);
                                                            case 17015:
                                                                return new t6.e(b("User has already been linked to the given provider.", status));
                                                            case 17016:
                                                                return new t6.e(b("User was not linked to an account with the given provider.", status));
                                                            case 17017:
                                                                break;
                                                            default:
                                                                switch (i10) {
                                                                    ...
                                                                    case 17025:
                                                                        break;
                                                                    case 17026:
                                                                        return new x6.k(c(i10), strB, status.f2774o);
                                                                    default:
                                                                        switch (i10) {
                                                                            case 17028:
                                                                                break;
                                                                            ...
                                                                            default:
                                                                                switch (i10) {
                                                                                    ...
                                                                                    default:
                                                                                        switch (i10) {
                                                                                            case 17061:
                                                                                                return new t6.g(b("There was a failure in the connection between the web widget and the Firebase Auth backend.", status));
                                                                                            case 17062:
                                                                                            case 17065:
                                                                                                break;
                                                                                            case 17063:
                                                                                            ...
                                                                                            default:
                                                                                                switch (i10) {
                                                                                                    ...
                                                                                                    case 17075:
                                                                                                        break;
                                                                                                    default:
                                                                                                        return new t6.e("An internal error has occurred.");
                                                                                                }
                                                                                            case 17064:
                                                                                                return new x6.h(c(i10), strB);
                                                                                        }
                                                                                        break;
                                                                                }
                                                                                break;
    ...
    public static String b(String str, Status status) {
        return TextUtils.isEmpty(status.f2774o) ? str : String.format(String.valueOf(str).concat(" [ %s ]"), status.f2774o);
    }
