...
public final class xb extends jd<Object, z6.x> {

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public final ea f13255n;

    public xb(x6.d dVar) {
        super(2);
        f4.q.j(dVar, "credential cannot be null or empty");
        this.f13255n = new ea(dVar);
    }

    @Override // v4.ob
    public final e4.m<ic, Object> a() {
        m.a aVarA = e4.m.a();
        aVarA.f5303a = new b1.o(this, 14);
        return aVarA.a();
    }
