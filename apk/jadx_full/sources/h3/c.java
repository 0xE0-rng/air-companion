    ...
    */
    public final List<g3.b> l() {
        ...
        for (int i10 = 0; i10 < 8; i10++) {
            if (!this.f7038k[i10].e()) {
                b[] bVarArr = this.f7038k;
                if (bVarArr[i10].f7050d) {
                    b bVar = bVarArr[i10];
                    if (bVar.e()) {
                        aVar = null;
                    } else {
                        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                        for (int i11 = 0; i11 < bVar.f7047a.size(); i11++) {
                            spannableStringBuilder.append((CharSequence) bVar.f7047a.get(i11));
                        ...
                        if (i12 == 0) {
                            ...
                            if (bVar.f7052f) {
                                f6 = bVar.f7054h / 209.0f;
                                f10 = bVar.f7053g / 74.0f;
                            } else {
                                f6 = bVar.f7054h / 99.0f;
                                f10 = bVar.f7053g / 99.0f;
                            }
                            float f11 = (f6 * 0.9f) + 0.05f;
                            ...
                            int i18 = bVar.f7060o;
                            aVar = new a(spannableStringBuilder, alignment2, f12, 0, i15, f11, i17, -3.4028235E38f, i18 == b.f7044x, i18, bVar.f7051e);
                        } else {
                            if (i12 == 1) {
                                alignment = Layout.Alignment.ALIGN_OPPOSITE;
                            } else if (i12 != 2) {
                                if (i12 != 3) {
                                    StringBuilder sbB = android.support.v4.media.a.b("Unexpected justification value: ");
                                    sbB.append(bVar.f7058l);
                            ...
                            float f112 = (f6 * 0.9f) + 0.05f;
                            float f122 = (f10 * 0.9f) + 0.05f;
                            int i132 = bVar.f7055i;
                            int i142 = i132 / 3;
                            if (i142 != 0) {
                            }
                            int i162 = i132 % 3;
                            ...
                            int i182 = bVar.f7060o;
                            aVar = new a(spannableStringBuilder, alignment22, f122, 0, i15, f112, i17, -3.4028235E38f, i182 == b.f7044x, i182, bVar.f7051e);
                        }
                    }
                    if (aVar != null) {
                        arrayList.add(aVar);
        ...
        Collections.sort(arrayList, h3.b.f7028n);
        ArrayList arrayList2 = new ArrayList(arrayList.size());
        for (int i19 = 0; i19 < arrayList.size(); i19++) {
            arrayList2.add(((a) arrayList.get(i19)).f7042a);
        }
