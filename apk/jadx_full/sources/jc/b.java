...
public final class b extends h.d<b> {
    ...
    public static final class C0138b extends h.c<b, C0138b> {
        ...
        */
        public C0138b q(qc.d dVar, qc.f fVar) throws Throwable {
            b bVar = null;
            try {
                try {
                    Objects.requireNonNull((a) b.L);
                    o(new b(dVar, fVar));
                    return this;
                } catch (qc.j e10) {
                    b bVar2 = (b) e10.m;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r12v16, resolved type: jc.v$b */
    /* JADX DEBUG: Multi-variable search result rejected for r4v54, resolved type: jc.s$b */
