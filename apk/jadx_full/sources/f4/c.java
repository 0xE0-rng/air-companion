    ...
    public final class g extends u4.d {
        ...
        */
        public final void handleMessage(Message message) {
            ...
            if (i11 == 4) {
                c.this.f5691t = new c4.b(message.arg2);
                if (c.F(c.this)) {
                    c cVar = c.this;
                    if (!cVar.u) {
                        cVar.C(3, null);
            ...
            if (i11 == 5) {
                c4.b bVar2 = c.this.f5691t;
                if (bVar2 == null) {
                    bVar2 = new c4.b(8);
                }
                c.this.f5683j.a(bVar2);
                Objects.requireNonNull(c.this);
                System.currentTimeMillis();
                return;
            }
            if (i11 == 3) {
                ...
                c.this.f5683j.a(new c4.b(message.arg2, obj instanceof PendingIntent ? (PendingIntent) obj : null));
                Objects.requireNonNull(c.this);
                System.currentTimeMillis();
                return;
            }
            ...
            if (!a(message)) {
                Log.wtf("GmsClient", a0.c.a(45, "Don't know how to handle message: ", message.what), new Exception());
                return;
            }
            h hVar4 = (h) message.obj;
            synchronized (hVar4) {
                tlistener = hVar4.f5698a;
                if (hVar4.f5699b) {
                    String strValueOf = String.valueOf(hVar4);
