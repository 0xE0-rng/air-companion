    ...
    */
    public int e(i iVar, k2.s sVar) {
        ...
        while (true) {
            ...
            boolean z11 = true;
            if (i10 == 1) {
                if (iVar.f(this.f9119b.f12266a, 0, 9, true)) {
                    this.f9119b.D(0);
                    this.f9119b.E(4);
                    int iS = this.f9119b.s();
                    boolean z12 = (iS & 4) != 0;
                    boolean z13 = (iS & 1) != 0;
                    if (z12 && this.f9131o == null) {
                        this.f9131o = new a(this.f9123f.j(8, 1));
                    }
                    if (z13 && this.p == null) {
                        this.p = new e(this.f9123f.j(9, 2));
                    }
                    this.f9123f.b();
                    this.f9127j = (this.f9119b.f() - 9) + 4;
                    this.f9124g = 2;
                } else {
                    z11 = false;
                }
                ...
                if (iVar.f(this.f9120c.f12266a, 0, 11, true)) {
                    this.f9120c.D(0);
                    this.f9128k = this.f9120c.s();
                    this.f9129l = this.f9120c.u();
                    this.m = this.f9120c.u();
                    this.m = (((long) (this.f9120c.s() << 24)) | this.m) * 1000;
                    this.f9120c.E(3);
                    this.f9124g = 4;
                } else {
                    z11 = false;
                ...
                long j10 = this.f9125h ? this.f9126i + this.m : this.f9122e.f9132b == -9223372036854775807L ? 0L : this.m;
                int i11 = this.f9128k;
                if (i11 == 8 && this.f9131o != null) {
                    c();
                    zA = this.f9131o.a(f(iVar), j10);
                } else if (i11 == 9 && this.p != null) {
                    c();
                    zA = this.p.a(f(iVar), j10);
                } else if (i11 != 18 || this.f9130n) {
                    iVar.k(this.f9129l);
                    zA = false;
                    z10 = false;
                    if (!this.f9125h && zA) {
                        this.f9125h = true;
                        this.f9126i = this.f9122e.f9132b != -9223372036854775807L ? -this.m : 0L;
                    }
                    this.f9127j = 4;
                    this.f9124g = 2;
                    if (!z10) {
                    ...
                    zA = this.f9122e.a(f(iVar), j10);
                    c cVar = this.f9122e;
                    long j11 = cVar.f9132b;
                    if (j11 != -9223372036854775807L) {
                        this.f9123f.k(new r(cVar.f9134d, cVar.f9133c, j11));
                        this.f9130n = true;
                    }
                }
                z10 = true;
