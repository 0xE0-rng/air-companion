...
public /* synthetic */ class a implements g, y, y1, q, c {
    ...
    /* JADX DEBUG: Class process forced to load method for inline: gd.f0.f(sb.h, gd.v0, java.util.List, boolean, hd.g, int):gd.l0 */
    ...
    /* JADX DEBUG: Class process forced to load method for inline: com.google.firebase.datatransport.TransportRegistrar.lambda$getComponents$0(a7.e):s1.g */
    @Override // a7.g
