...
public final class t extends e<Object> implements kotlin.jvm.internal.e<Object>, kb.e<Object>, db.a, db.l, db.b, db.c, db.d, db.e, db.f, db.g, db.h, db.i, db.j, db.k, db.p, db.m, db.n, db.o, db.q, db.r, db.s, db.t, db.u, db.v, db.w {
    ...
    public static final class b extends kotlin.jvm.internal.h implements db.a<nb.e<? extends Member>> {
        ...
        */
        public nb.e<? extends Member> d() {
            ...
            w0 w0Var = w0.f8907b;
            mb.c cVarD = w0.d(t.this.j());
            if (cVarD instanceof c.e) {
                t tVar = t.this;
                p pVar = tVar.p;
                e.b bVar = ((c.e) cVarD).f8772b;
                String str = bVar.f9366a;
                String str2 = bVar.f9367b;
                Member memberB = tVar.h().b();
                j2.y.d(memberB);
                boolean z10 = !Modifier.isStatic(memberB.getModifiers());
                Objects.requireNonNull(pVar);
                j2.y.f(str, "name");
                j2.y.f(str2, "desc");
                if (j2.y.a(str, "<init>")) {
                    ...
                    pVar.e(arrayList, str2, false);
                    Class<?> clsK = pVar.k();
                    String strB = d.a.b(str, "$default");
                    Object[] array = arrayList.toArray(new Class[0]);
                    Objects.requireNonNull(array, "null cannot be cast to non-null type kotlin.Array<T>");
                    genericDeclarationQ = pVar.o(clsK, strB, (Class[]) array, pVar.n(str2), z10);
                }
            } else if (!(cVarD instanceof c.d)) {
                if (cVarD instanceof c.a) {
                    List<Method> list = ((c.a) cVarD).f8764a;
                    Class<?> clsD = t.this.p.d();
                    ...
                    return new nb.a(clsD, arrayList2, a.EnumC0184a.CALL_BY_NAME, a.b.JAVA, list);
                }
                genericDeclarationQ = null;
            } else {
                if (t.this.k()) {
                    ...
                    ArrayList<kb.g> arrayListD = t.this.m.d();
                    j2.y.e(arrayListD, "_parameters()");
                    ArrayList<kb.g> arrayList3 = arrayListD;
                    ...
                    return new nb.a(clsD2, arrayList4, a.EnumC0184a.CALL_BY_NAME, a.b.KOTLIN, null, 16);
                }
                p pVar2 = t.this.p;
                String str3 = ((c.d) cVarD).f8770b.f9367b;
                Objects.requireNonNull(pVar2);
                j2.y.f(str3, "desc");
                Class<?> clsD3 = pVar2.d();
                ArrayList arrayList5 = new ArrayList();
                pVar2.e(arrayList5, str3, true);
                genericDeclarationQ = pVar2.q(clsD3, arrayList5);
            }
            if (genericDeclarationQ instanceof Constructor) {
                t tVar2 = t.this;
                eVarN = t.m(tVar2, (Constructor) genericDeclarationQ, tVar2.j());
            } else if (!(genericDeclarationQ instanceof Method)) {
                eVarN = null;
            } else if (t.this.j().s().g(y0.f8925a) != null) {
                rb.k kVarC = t.this.j().c();
                Objects.requireNonNull(kVarC, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                if (((rb.e) kVarC).K()) {
                    eVarN = t.n(t.this, (Method) genericDeclarationQ);
                } else {
                    Method method2 = (Method) genericDeclarationQ;
                    eVarN = t.this.l() ? new f.g.b(method2) : new f.g.e(method2);
                }
            }
            return eVarN != null ? androidx.navigation.fragment.b.g(eVarN, t.this.j(), true) : null;
        }
    }
    ...
    /* JADX DEBUG: Method merged with bridge method: j()Lrb/b; */
    @Override // mb.e
