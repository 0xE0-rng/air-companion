...
public class c0<T, V> extends e0<V> implements kb.h<T, V> {
    ...
    public static final class a<T, V> extends e0.b<V> implements h.a<T, V> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: mb.c0<T, ? extends V> */
    ...
    /* JADX DEBUG: Method merged with bridge method: o()Lmb/e0$b; */
    /* JADX DEBUG: Method merged with bridge method: r()Lkb/h$a; */
    @Override // kb.h
