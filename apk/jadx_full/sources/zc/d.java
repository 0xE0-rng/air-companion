...
public final class d {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: java.util.List<? extends zc.c> */
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0008: CONSTRUCTOR 
      (r1v0 int)
      (wrap:va.n:?: TERNARY null = ((wrap:int:0x0000: ARITH (r3v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (wrap:??:0x0004: SGET  A[WRAPPED] va.n.m va.n) : (null va.n))
     A[MD:(int, java.util.List<? extends zc.c>):void (m)] call: zc.d.<init>(int, java.util.List):void type: THIS */
