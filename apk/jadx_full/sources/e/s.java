...
public class s {
    ...
    public void a(long j10, double d10, double d11) {
        ...
        double dSin2 = (Math.sin(2.0d * dSin) * (-0.0069d)) + (Math.sin(d12) * 0.0053d) + ((double) (Math.round(((double) (r3 - 9.0E-4f)) - r9) + 9.0E-4f)) + ((-d11) / 360.0d);
        ...
        if (dSin3 >= 1.0d) {
            ...
            this.f4591a = Math.round((dSin2 + dAcos) * 8.64E7d) + 946728000000L;
            long jRound = Math.round((dSin2 - dAcos) * 8.64E7d) + 946728000000L;
            this.f4592b = jRound;
            if (jRound >= j10 || this.f4591a <= j10) {
                this.f4593c = 1;
            } else {
                this.f4593c = 0;
            }
