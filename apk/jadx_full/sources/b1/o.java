...
public class o implements b.a, n.d, e4.k, b2, kd, c2, k5.a {
    ...
    */
    public synchronized org.acra.data.a k(Reader reader) {
        ...
        while (true) {
            try {
                ...
                if (i23 == i16) {
                    ...
                    if (i18 >= 0) {
                        String str = new String(cArr, i17, i21);
                        String strSubstring = str.substring(i18);
                        if (i19 == i15) {
                            strSubstring = strSubstring + "\u0000";
                        }
                        p(aVar, str.substring(i17, i18), strSubstring);
                    }
                    b4.t.s(reader);
                } else {
                    char c11 = (char) i23;
                    if (i21 == cArr.length) {
                        char[] cArr2 = new char[cArr.length * i14];
                        System.arraycopy(cArr, i17, cArr2, i17, i21);
                        cArr = cArr2;
                    }
                    if (i19 != i14) {
                        if (i19 != i15) {
                            ...
                            if (c11 != '\r') {
                                if (c11 == '!' || c11 == '#') {
                                    ...
                                    if (z10) {
                                        while (true) {
                                            int i25 = bufferedReader.read();
                                            if (i25 == i24 || (c10 = (char) i25) == '\r' || c10 == '\n' || c10 == 133) {
                                                break;
                                            }
                                            i24 = -1;
                                        }
                            ...
                            if (i21 <= 0 || (i21 == 0 && i18 == 0)) {
                                ...
                                p(aVar, str2.substring(0, i18), str2.substring(i18));
                            } else {
                                i10 = -1;
                                i11 = 0;
                            }
                            ...
                            i11 = 0;
                            String str22 = new String(cArr, 0, i21);
                            p(aVar, str22.substring(0, i18), str22.substring(i18));
                            i18 = i10;
                            i17 = i11;
                            i19 = i17;
                            i21 = i19;
