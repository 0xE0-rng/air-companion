...
public abstract class g implements Cloneable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v5, resolved type: V */
    ...
    */
    public void o(ViewGroup viewGroup, n nVar, n nVar2, ArrayList<m> arrayList, ArrayList<m> arrayList2) {
        ...
        while (i11 < size) {
            ...
            if (mVar3 != null && !mVar3.f2008c.contains(this)) {
                mVar3 = null;
            }
            if (mVar4 != null && !mVar4.f2008c.contains(this)) {
                mVar4 = null;
            }
            if (mVar3 != null || mVar4 != null) {
                if (!(mVar3 == null || mVar4 == null || v(mVar3, mVar4)) || (animatorN = n(viewGroup, mVar3, mVar4)) == null) {
                    i10 = size;
                } else {
                    if (mVar4 != null) {
                        View view2 = mVar4.f2007b;
                        String[] strArrT = t();
                        if (strArrT != null && strArrT.length > 0) {
                            mVar2 = new m(view2);
                            m mVar5 = (m) ((o.a) nVar2.m).get(view2);
                            if (mVar5 != null) {
                                int i12 = 0;
                                while (i12 < strArrT.length) {
                                    mVar2.f2006a.put(strArrT[i12], mVar5.f2006a.get(strArrT[i12]));
                                    i12++;
                                    animatorN = animatorN;
                                    size = size;
                                    mVar5 = mVar5;
                            ...
                            while (true) {
                                ...
                                b bVar = aVarS.get(aVarS.h(i14));
                                if (bVar.f1992c != null && bVar.f1990a == view2 && bVar.f1991b.equals(this.m) && bVar.f1992c.equals(mVar2)) {
                                    animator2 = null;
                                    break;
                                }
                                i14++;
                    ...
                    if (animator != null) {
                        String str = this.m;
                        Property<View, Float> property = p.f2012a;
                        aVarS.put(animator, new b(view, str, this, new s(viewGroup), mVar));
                        this.D.add(animator);
                    }
                }
            }
    ...
    */
    public m r(View view, boolean z10) {
        ...
        ArrayList<m> arrayList = z10 ? this.w : this.f1987x;
        if (arrayList == null) {
            return null;
        }
        int size = arrayList.size();
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v5, resolved type: V */
    /* JADX WARN: Multi-variable type inference failed */
