...
public class AppMeasurementDynamiteService extends ga {
    ...
    */
    public void setCurrentScreen(@RecentlyNonNull b bVar, @RecentlyNonNull String str, @RecentlyNonNull String str2, long j10) {
        x();
        y4 y4VarY = this.f2831a.y();
        Activity activity = (Activity) d.C(bVar);
        if (!((m3) y4VarY.m).f6427s.y()) {
            ((m3) y4VarY.m).e().w.a("setCurrentScreen cannot be called while screen reporting is disabled.");
            return;
        }
        u4 u4Var = y4VarY.f6632o;
        if (u4Var == null) {
            ((m3) y4VarY.m).e().w.a("setCurrentScreen cannot be called while no activity active");
            return;
        }
        if (y4VarY.f6634r.get(activity) == null) {
            ((m3) y4VarY.m).e().w.a("setCurrentScreen must be called with an activity in the activity lifecycle");
            return;
        }
        if (str2 == null) {
            str2 = y4VarY.r(activity.getClass(), "Activity");
        }
        boolean zH = h6.H(u4Var.f6587b, str2);
        boolean zH2 = h6.H(u4Var.f6586a, str);
        if (zH && zH2) {
            ((m3) y4VarY.m).e().w.a("setCurrentScreen cannot be called with the same class and name");
            return;
        }
        if (str != null) {
            if (str.length() > 0) {
            ...
            ((m3) y4VarY.m).e().w.b("Invalid screen name length in setCurrentScreen. Length", Integer.valueOf(str.length()));
            return;
        }
        if (str2 != null) {
            if (str2.length() > 0) {
            ...
            ((m3) y4VarY.m).e().w.b("Invalid class name length in setCurrentScreen. Length", Integer.valueOf(str2.length()));
            return;
        }
        ((m3) y4VarY.m).e().f6454z.c("Setting current screen to name, class", str == null ? "null" : str, str2);
        u4 u4Var2 = new u4(str, str2, ((m3) y4VarY.m).t().e0());
        y4VarY.f6634r.put(activity, u4Var2);
        y4VarY.m(activity, u4Var2, true);
    }
