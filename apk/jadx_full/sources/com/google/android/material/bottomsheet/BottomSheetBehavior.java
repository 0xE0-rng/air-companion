...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    public void F(View view, int i10, int i11, boolean z10) {
        ...
        if (cVar != null) {
            if (!z10) {
                ...
                cVar.f9092r = view;
                cVar.f9079c = -1;
                boolean zL = cVar.l(left, i11, 0, 0);
                if (!zL && cVar.f9077a == 0 && cVar.f9092r != null) {
                    cVar.f9092r = null;
                }
                if (zL) {
                }
            } else if (cVar.t(view.getLeft(), i11)) {
                z11 = true;
            }
        }
        if (!z11) {
        ...
        H(i10);
        if (this.f2913n == null) {
            this.f2913n = new e(view, i10);
        }
        BottomSheetBehavior<V>.e eVar = this.f2913n;
        if (eVar.f2930n) {
            eVar.f2931o = i10;
            return;
        }
        ...
        if (weakReference != null && view == weakReference.get() && this.C) {
            if (this.B > 0) {
                ...
                if (velocityTracker == null) {
                    ...
                    velocityTracker.computeCurrentVelocity(1000, this.f2903c);
                ...
                if (!this.f2902b) {
                    int i14 = this.f2916r;
                    if (top2 < i14) {
                        if (top2 < Math.abs(top2 - this.f2918t)) {
                            i11 = this.p;
                        } else {
                            i11 = this.f2916r;
                        }
                    } else if (Math.abs(top2 - i14) < Math.abs(top2 - this.f2918t)) {
                        i11 = this.f2916r;
                    } else {
                        i11 = this.f2918t;
                        i12 = 4;
                    ...
                    i12 = 6;
                } else if (Math.abs(top2 - this.f2915q) < Math.abs(top2 - this.f2918t)) {
                    i11 = this.f2915q;
                } else {
                    i11 = this.f2918t;
                    i12 = 4;
                ...
                if (this.f2902b) {
                    ...
                    int top3 = v8.getTop();
                    if (Math.abs(top3 - this.f2916r) < Math.abs(top3 - this.f2918t)) {
                        i11 = this.f2916r;
                        i12 = 6;
                    } else {
                        i11 = this.f2918t;
    ...
    */
    public void z(int i10) {
        ...
        } else if (this.f2905e || this.f2904d != i10) {
            this.f2905e = false;
            this.f2904d = Math.max(0, i10);
        }
        if (z10) {
            J(false);
        }
